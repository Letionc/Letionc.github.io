...
const insertCodeConfig = {
  ...
  'assert-ifelse': `if true then${twoLineBreak}else${twoLineBreak}end${lineBreak}`,
  'assert-if': `if true then${twoLineBreak}end${lineBreak}`,
...
function titleChange(titleChange_Param_1){
	document.title = titleChange_Param_1;
	return;
};
