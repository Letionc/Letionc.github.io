...
snippet coroutine.create 创建\n\
	coroutine.create(${1:func})\n\
snippet coroutine.resume (重新)执行\n\
	coroutine.resume(${1:coroutineName})\n\
snippet coroutine.yield 暂时暂停\n\
	coroutine.yield(${1:result})--[[coroutine中使用]]\n\
snippet coroutine.status 看状态\n\
	coroutine.status(${1:coroutineName})--[[dead完毕 running没完 suspended暂停]]\n\
snippet (Custom)EventDispatch事件分发\n\
	Game:dispatchEvent('${1:EventName}',{customdata = ${2:eventJson}})\n\
snippet function创建函数\n\
...
snippet for pairs迭代器语句\n\
	for key,value in pairs(${1:tab}) do\n\
		print(k,v)\n\
	end\n\
snippet while 循环语句\n\
	${1:val} = 0\n\
...
snippet Event\n\
	ScriptSupportEvent:registerEvent([=[]=],func)\n\
snippet 绘制长方体\n\
	--设置起点坐标\n\
	local mapx = 0 \n\
	local mapy = 7 \n\
...
function GetServiceFuncs() {
	var jsonObj = [
		...
		{"name":"Player.hideUIView", "caption":"Player:hideUIView", "value":"Player:hideUIView(uin,uiid)", "meta":"Customui", "type":"local", "score":9},{"name":"ScriptSupportEvent.registerEvent","caption":"ScriptSupportEvent:registerEvent","value":"ScriptSupportEvent:registerEvent([=[event]=],func)","meta":"(Custom)","type":"local","score":9},
