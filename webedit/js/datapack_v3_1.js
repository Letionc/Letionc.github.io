...
snippet V3 Script模板\n\
	...
	return Script\n\
snippet V3 UI Script模板\n\
	local ui=${1:\"aaaaabbbbbcccccddddd-eeeeee\"} -- 27个字符\n\
	local ui_=ui..'_'\n\
	local elements={\n\
		a=ui_..'1'\n\
	}\n\
...
{"meta":"World","type":"local","score":9,"name":"World.SetLightByPos","caption":"World:SetLightByPos","value":"World:SetLightByPos(x, y, z, light_lv, WorldId)\n-- 返回：ret: boolean 成功(true)" },
{"meta":"World","type":"local","score":9,"name":"World.AddGravity","caption":"World:AddGravity","value":"World:AddGravity(g)\n-- 返回：ret: boolean 成功(true)" },
...
{"meta":"Actor","type":"local","score":9,"name":"Actor.SetAttr","caption":"Actor:SetAttr","value":"Actor:SetAttr(objid,RoleAttr,val)\n-- 返回：ret:bool设置成功(true)\n"},
{"meta":"Actor","type":"local","score":9,"name":"Actor.IncreasesAttr","caption":"Actor:IncreasesAttr","value":"Actor:IncreasesAttr(objid,RoleAttr,val)\n-- 返回：ret:bool设置成功(true)\n"},
{"meta":"Actor","type":"local","score":9,"name":"Actor.GetAttr","caption":"Actor:GetAttr","value":"Actor:GetAttr(objid,RoleAttr)\n-- 返回：value:number属性值\n"},
...
{"meta":"Actor","type":"local","score":9,"name":"Actor.PlayAnimByObj","caption":"Actor:PlayAnimByObj","value":"Actor:PlayAnimByObj(objidDo,objidDid,isReplay)\n-- 返回：ret:bool成功(true)\n"},
...
{"meta":"Actor","type":"local","score":9,"name":"Actor.PickupActor2","caption":"Actor:PickupActor2","value":"Actor:PickupActor(objid,targetobjid,100502,100113,offset,rotate)\n-- 返回：ret:bool抓取成功(true)\n"},
...
{"meta":"Actor","type":"local","score":9,"name":"Actor.GetTags","caption":"Actor:GetTags","value":"Actor:GetTags(objid)\n-- 返回：tags: table | nil\n"},
{"meta":"Actor","type":"local","score":9,"name":"Actor.HasTags","caption":"Actor:HasTags","value":"Actor:HasTags(objid，tags, MatchMode.All, isExactMatch)\n-- 返回：ret: bool true(是) (真实性有待探究)\n"},
{"meta":"Actor","type":"local","score":9,"name":"Actor.AddTags","caption":"Actor:AddTags","value":"Actor:AddTags(objid，tags, total)\n-- 返回：ret: bool true(成功)\n"},
{"meta":"Actor","type":"local","score":9,"name":"Actor.RemoveTags","caption":"Actor:RemoveTags","value":"Actor:RemoveTags(objid，tags, 0)\n-- 返回：ret: bool true(成功)\n"},
{"meta":"Actor","type":"local","score":9,"name":"Actor.ClearTags","caption":"Actor:ClearTags","value":"Actor:ClearTags(objid)\n-- 返回：ret: bool true(成功)\n"},
{"meta":"Actor","type":"local","score":9,"name":"Actor.GetObjWorldId","caption":"Actor:GetObjWorldId","value":"Actor:GetObjWorldId(objid)\n-- 返回：map_world_id: number\n"},
...
{"meta":"Player","type":"local","score":9,"name":"Player.RemovePlayer","caption":"Player:RemovePlayer","value":"Player:RemovePlayer(uin)\n-- 返回：ret: boolean 成功(true)\n"},
...
{"meta":"Monster","type":"local","score":9,"name":"Monster.GetFacade","caption":"Monster:GetFacade","value":"Monster:GetFacade(monsterid)\n-- 返回：model:string模型名称 （如果是prefab资源会带有子部件信息，选择器选择不带子部件信息）\n"},
{"meta":"Monster","type":"local","score":9,"name":"Monster.GetTags","caption":"Monster:GetTags","value":"Monster:GetFacade(actorid)\n-- 返回：ret: table | nil\n"},
...
{"meta":"Item","type":"local","score":9,"name":"Item.GetTags","caption":"Item:GetTags","value":"Item:GetTags(itemid)\n-- 返回：tags:table | nil\n"},
...
{"meta":"CustomUI","type":"local","score":9,"name":"CustomUI.DeleteElement","caption":"CustomUI:DeleteElement","value":"CustomUI:DeleteElement(playerid， uiid, elementid)\n-- 返回：ret: boolean 成功(true)\n"},
...
{"meta":"Graphics","type":"local","score":9,"name":"Graphics.UpdateGraphicsProgressById","caption":"Graphics:UpdateGraphicsProgressById","value":"Graphics:UpdateGraphicsProgressById(graph_id, value1, value2, is_sync)\n-- 返回：ret:boolean成功(true)\n"},
{"meta":"Graphics","type":"local","score":9,"name":"Graphics.UpdateGraphicsTextById","caption":"Graphics:UpdateGraphicsTextById","value":"Graphics:UpdateGraphicsTextById(graph_id, title, fontsize, alpha, is_sync)\n-- 返回：ret:boolean成功(true)\n"},
...
{"meta":"Data","type":"local","score":9,"name":"Data.IncreasesValue","caption":"Data:IncreasesValue","value":"Data:IncreasesValue(varId,playerId,value)\n-- 返回：value: any 返回值 (真实性需要探究)\n"},
...
{"meta":"Array","type":"local","score":9,"name":"Array.IncreasesValue","caption":"Array:IncreasesValue","value":"Data.Array:IncreasesValue(varId,playerId,value,index)\n-- 返回：ret:bool是否成功\n"},
...
{"meta": "Map","type": "local","score": 9,"name": "Map.SetValueAndCallBack","caption": "Map:SetValueAndCallBack","value": "Map:SetValueAndCallBack(varId, playerId, key, value, callback)\n-- 返回值及类型：  code:bool是否调用成功 非全局云变量建议使用阻塞接口\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.SetValueAndBlock","caption": "Map:SetValueAndBlock","value": "Map:SetValueAndBlock(call_back, varId, playerId, key, value)\n-- 返回值及类型：  code:number错误码（ErrorCode）ErrorCode  key:string键值  value:string,number,boolean具体值\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.RemoveValueAndCallBack","caption": "Map:RemoveValueAndCallBack","value": "Map:RemoveValueAndCallBack(varId, playerId, key, callback)\n-- 返回值及类型：  ret:bool是否调用成功 非全局云变量建议使用阻塞接口\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.RemoveValueAndBlock","caption": "Map:RemoveValueAndBlock","value": "Map:RemoveValueAndBlock(call_back, varId, playerId, key)\n-- 返回值及类型：  code:number错误码（ErrorCode）ErrorCode  key:string键值\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.UpdateValueAndCallback","caption": "Map:UpdateValueAndCallback","value": "Map:UpdateValueAndCallback(varId, playerId, key, value)\n-- 返回值及类型：  ret:bool是否成功 (全局云KV变量可用)\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.GetValueAndCallBack","caption": "Map:GetValueAndCallBack","value": "Map:GetValueAndCallBack(varId, playerId, key, callback)\n-- 返回值及类型：  ret:bool是否调用成功 非全局云变量建议使用阻塞接口\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.GetValueAndBlock","caption": "Map:GetValueAndBlock","value": "Map:GetValueAndBlock(varId, playerId, key)\n-- 返回值及类型：  code:number错误码（ErrorCode）ErrorCode  key:string键值  value:string,number,boolean具体值\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.GetIndexValueAndCallback","caption": "Map:GetIndexValueAndCallback","value": "Map:GetIndexValueAndCallback(varId, playerId, index, ascending, callback)\n-- 返回值及类型： bool:是否调用成功 非全局云变量建议使用阻塞接口\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.GetIndexValueAndBlock","caption": "Map:GetIndexValueAndBlock","value": "Map:GetIndexValueAndBlock(varId, playerId, index, ascending)\n-- 返回值及类型：  code:number错误码（ErrorCode）ErrorCode  key:string键值  value:any具体值  index:number排名索引  ascending:bool是否升序\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.GetNumValuesAndCallback","caption": "Map:GetNumValuesAndCallback","value": "Map:GetNumValuesAndCallback(varId, playerId, num, ascending, callback)\n-- 返回值及类型：  ret:bool是否调用成功\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.GetRangeValuesAndCallback","caption": "Map:GetRangeValuesAndCallback","value": "Map:GetRangeValuesAndCallback(varId, playerId, min, max, ascending, pagesize, callback)\n-- 返回值及类型：  ret:bool是否调用成功\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.SetRankValueAndBlock","caption": "Map:SetRankValueAndBlock","value": "Map:SetRankValueAndBlock(call_back, varId, playerId, key, value, extendvalue)\n-- 返回值及类型：  code:number错误码（ErrorCode）ErrorCode  key:string键值  value:number数值\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.ClearData","caption": "Map:ClearData","value": "Map:ClearData(varId, playerId)\n-- 返回值及类型：  ret:bool是否成功\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.IncreasesRankValueAndBlock","caption": "Map:IncreasesRankValueAndBlock","value": "Map:IncreasesRankValueAndBlock(call_back, varId, playerId, key, value, extendvalue)\n-- 返回值及类型：  code:number错误码（ErrorCode）ErrorCode  key:string键值  value:number数值\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.IncreasesRankValueAndCallback","caption": "Map:IncreasesRankValueAndCallback","value": "Map:IncreasesRankValueAndCallback(call_back, varId, playerId, key, value, extendvalue)\n-- 返回值及类型：  code:number错误码（ErrorCode）ErrorCode  key:string键值  value:number数值\n"},
{"meta": "Map","type": "local","score": 9,"name": "Map.GetRangeIndexsAndCallback","caption": "Map:GetRangeIndexsAndCallback","value": "Map:GetRangeIndexsAndCallback(varId, playerId, min, max, ascending, pagesize, callback)\n-- 返回值及类型：  ret:bool是否调用成功\n"},
];
$s('#loadPage>h3[data-v3-1]').remove();