...
return o(l, e) || (a && o(h, e) ? l[e] = h[e] : l[e] = u("Symbol." + e)),
l[e]
}
},
function(e, t, i) {
...
p = e.global,
m = e.stat;
if (i = p ? n: m ? n[f] || a(f, {}) : (n[f] || {}).prototype) for (h in t) {
...
l = c.get,
h = c.enforce,
u = String(String).split("String"); (e.exports = function(e, t, i, a) {
var c = !!a && !!a.unsafe,
l = !!a && !!a.enumerable,
d = !!a && !!a.noTargetGet;
"function" == typeof i && ("string" != typeof t || o(i, "name") || r(i, "name", t), h(i).source = u.join("string" == typeof t ? t: "")),
e !== n ? (c ? !d && e[t] && (l = !0) : delete e[t], l ? e[t] = i: r(e, t, i)) : l ? e[t] = i: s(t, i)
...
for (var v, w, b = o(g), y = r(b), C = n(f, p, 3), S = s(y.length), k = 0, x = m || a, $ = t ? x(g, S) : i ? x(g, 0) : void 0; S > k; k++) if ((d || k in y) && (w = C(v = y[k], k, b), e)) if (t) $[k] = w;
else if (w) switch (e) {
case 3:
return ! 0;
case 5:
...
function(e, t, i) { (function(e) { (function() {
var e = function() {
return this
...
var r = e;
i && (e[i] || (e[i] = {}), r = e[i]),
r.define && r.define.packaged || (t.original = r.define, r.define = t, r.define.packaged = !0),
r.require && r.require.packaged || (n.original = r.require, r.require = n, r.require.packaged = !0)
} ("ace")
})(),
...
}))), this._xregexp && this._xregexp.captureNames) for (var l = 1; l < c.length; l++)(t = this._xregexp.captureNames[l - 1]) && (c[t] = c[l]); ! a && this.global && !c[0].length && this.lastIndex > c.index && this.lastIndex--
}
return c
},
...
return t.prototype && (n.prototype = t.prototype, r.prototype = new n, n.prototype = null),
r
});
...
if ((h = m(g, "__defineGetter__")) && (s = u.bind(g.__defineGetter__), a = u.bind(g.__defineSetter__), c = u.bind(g.__lookupGetter__), l = u.bind(g.__lookupSetter__)), 2 != [1, 2].splice(0).length) if (function() {
function e(e) {
var t = new Array(e + 2);
return t[0] = t[1] = 0,
t
...
var i = this.length;
e > 0 ? e > i && (e = i) : null == e ? e = 0 : e < 0 && (e = Math.max(i + e, 0)),
e + t < i || (t = i - e);
...
l = i - a,
h = i - s;
if (c < a) for (var u = 0; u < l; ++u) this[c + u] = this[a + u];
else if (c > a) for (u = l; u--;) this[c + u] = this[a + u];
if (o && e === h) this.length = h,
this.push.apply(this, r);
else for (this.length = h + o, u = 0; u < o; ++u) this[e + u] = r[u]
}
return n
};
...
r = arguments[1];
if ("[object Function]" != p(e)) throw new TypeError(e + " is not a function");
for (var o = 0; o < n; o++) if (o in i && !e.call(r, i[o], o, t)) return ! 1;
return ! 0
...
r = arguments[1];
if ("[object Function]" != p(e)) throw new TypeError(e + " is not a function");
for (var o = 0; o < n; o++) if (o in i && e.call(r, i[o], o, t)) return ! 0;
return ! 1
...
var r = c(e, t),
o = l(e, t);
if (e.__proto__ = n, r || o) return r && (i.get = r),
o && (i.set = o),
i
}
return i.value = e[t],
...
}), Object.create) || (w = null === Object.prototype.__proto__ ?
function() {
return {
__proto__: null
}
...
t.isMac = "mac" == r,
t.isLinux = "linux" == r,
t.isIE = "Microsoft Internet Explorer" == s || s.indexOf("MSAppHost") >= 0 ? parseFloat((o.match(/(?:MSIE |Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/) || [])[1]) : parseFloat((o.match(/(?:Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/) || [])[1]),
...
t.HI_DPI && void 0 !== r.style.transform && (t.HAS_CSS_TRANSFORMS = !0),
!n.isEdge && void 0 !== r.style.animationName && (t.HAS_CSS_ANIMATION = !0),
r = null
}
...
for (t in i.FUNCTION_KEYS) e = i.FUNCTION_KEYS[t].toLowerCase(),
i[e] = parseInt(t, 10);
for (t in i.PRINTABLE_KEYS) e = i.PRINTABLE_KEYS[t].toLowerCase(),
i[e] = parseInt(t, 10);
...
void 0 !== e.wheelDeltaX ? (e.wheelX = -e.wheelDeltaX / 8, e.wheelY = -e.wheelDeltaY / 8) : (e.wheelX = 0, e.wheelY = -e.wheelDelta / 8),
i(e)
...
var a = null;
n(e, "keydown",(function(e){
$s('#updated').THEN(e=>e.style('color','#940').intext('未保存'));if((e.ctrlKey||e.metaKey)&&e.key=='s'){e.preventDefault();window.fileOperations.saveFile();}
...
var i = [];
if (t) for (var n = v.parentElement; n && 1 == n.nodeType;) i.push(n),
...
var i = "\n ab" + e + "cde fg\n";
i != v.value && (v.value = $ = i);
var n = 4 + (e.length || (t.selection.isEmpty() ? 0 : 1)); (4 != A || E != n) && v.setSelectionRange(4, n),
A = 4,
E = n
}
}: function() {
...
r = i.start.row < n - 1 ? 0 : r,
o += a.length + 1,
s = a + "\n" + s
} else if (i.end.row != n) {
var c = t.session.getLine(n + 1);
o = i.end.row > n + 1 ? c.length: o,
o += s.length + 1,
s = s + "\n" + c
}
...
h = 0; o > 0 && $[h] == e[h];) h++,
o--;
for (a = a.slice(h), h = 1; s > 0 && $.length - h > A - 1 && $[$.length - h] == e[e.length - h];) h++,
s--;
c -= h - 1,
l -= h - 1;
var u = a.length - h + 1;
return u < 0 && (o = -u, u = 0),
a = a.slice(0, u),
i || a || c || o || s || l ? (C = !0, a && !o && !s && !c && !l || k ? t.onTextInput(a) : t.onTextInput(a, {
extendLeft: o,
extendRight: s,
restoreStart: c,
restoreEnd: l
...
var i = v.value,
n = O(i, !0); (i.length > 500 || p.test(n)) && _()
},
I = function(e, t, i) {
...
n.addCommandKeyListener(v, t.onCommandKey.bind(t)),
n.addListener(v, "select", (function(e) {
y || (w ? w = !1 : function(e) {
return 0 === e.selectionStart && e.selectionEnd >= $.length && e.value === $ && $ && e.selectionEnd !== E
} (v) && (t.selectAll(), _()))
})),
n.addListener(v, "input", F),
n.addListener(v, "cut", B),
n.addListener(v, "copy", N),
n.addListener(v, "paste", D),
(!("oncut" in v) || !("oncopy" in v) || !("onpaste" in v)) && n.addListener(e, "keydown", (function(e) {
...
var e = v.value;
O(e),
y.markerRange && (y.context && (y.markerRange.start.column = y.selectionStart = y.context.compositionStartOffset), y.markerRange.end.column = y.markerRange.start.column + E - y.selectionStart + L)
}
}
},
H = function(e) {
...
if (!y && t.onCompositionStart && !t.$readOnly && (y = {},
!k)) {
setTimeout(P, 0),
t.on("mousedown", i);
...
y.markerRange = n,
y.selectionStart = A,
t.onCompositionStart(y),
y.useTextareaForIME ? (v.value = "", $ = "", A = 0, E = 0) : (v.msGetInputContext && (y.context = v.msGetInputContext()), v.getInputContext && (y.context = v.getInputContext()))
}
})),
n.addListener(v, "compositionupdate", P),
n.addListener(v, "keyup", (function(e) {
27 == e.keyCode && v.value.length < v.selectionStart && (y || ($ = v.value), A = E = -1, _()),
z()
})),
n.addListener(v, "keydown", z),
n.addListener(v, "compositionend", H),
...
S || (S = v.style.cssText),
v.style.cssText = (i ? "z-index:100000;": "") + (r.isIE ? "opacity:0.1;": "") + "text-indent: -" + (A + E) * t.renderer.characterWidth * .5 + "px;";
...
u(e),
"mousedown" == e.type && (t.renderer.$isMousePressed = !0, clearTimeout(U), r.isWin && n.capture(t.container, u, m))
},
...
n.addListener(v, "mouseup", K),
n.addListener(v, "mousedown", (function(e) {
e.preventDefault(),
m()
})),
n.addListener(t.renderer.scroller, "contextmenu", K),
n.addListener(v, "contextmenu", K),
f &&
function(e, t, i) {
var n = null,
r = !1;
...
var o = e("../lib/useragent"); (function() {
...
if (-1 == s && a <= 0) t = this.$clickSelection.end,
o.end.row == n.row && o.end.column == n.column || (n = o.start);
else if (1 == a && s >= 0) t = this.$clickSelection.start,
o.start.row == n.row && o.start.column == n.column || (n = o.end);
else if (-1 == s && 1 == a) n = o.end,
t = o.start;
else {
...
t = Date.now(); (e > 0 || t - this.mousedownEvent.time > this.$focusTimeout) && this.startSelect(this.mousedownEvent.getDocumentPosition())
},
this.onDoubleClick = function(e) {
var t = e.getDocumentPosition(),
i = this.editor,
n = i.session.getBracketRange(t);
n ? (n.isEmpty() && (n.start.column--, n.end.column++), this.setState("select")) : (n = i.selection.getWordRange(t.row, t.column), this.setState("selectByWords")),
...
n.isMultiLine() && n.contains(t.row, t.column) ? (this.$clickSelection = i.selection.getLineRange(n.start.row), this.$clickSelection.end = i.selection.getLineRange(n.end.row).end) : this.$clickSelection = i.selection.getLineRange(t.row),
this.select()
},
...
i.vx = o,
i.vy = s,
c ? (t.renderer.scrollBy(e.wheelX * e.speed, e.wheelY * e.speed), e.stop()) : void 0
}
}
}).call(n.prototype),
t.DefaultHandlers = n
...
r = this.getWidth(),
o = this.getHeight(); (e += 15) + r > i && (e -= e + r - i),
(t += 15) + o > n && (t -= 20 + o),
...
if (l != n) if (l = n.text.join("<br/>"), d.setHtml(l), d.show(), h._signal("showGutterTooltip", d), h.on("mousewheel", i), e.$tooltipFollowsMouse) o(c);
else {
...
function i() {
a && (a = clearTimeout(a)),
l && (d.hide(), l = null, h._signal("hideGutterTooltip", d), h.removeEventListener("mousewheel", i))
}
function o(e) {
...
if (2 == t.domEvent.detail) return h.selectAll(),
t.preventDefault();
...
l && e.$tooltipFollowsMouse && o(n),
c = n,
a || (a = setTimeout((function() {
a = null,
c && !e.isMousePressed ? t() : i()
}), 50))
})),
s.addListener(h.renderer.$gutter, "mouseout", (function(e) {
c = null,
l && !a && (a = setTimeout((function() {
a = null,
i()
}), 50))
})),
...
var i = Date.now(),
n = !t || e.row != t.row,
o = !t || e.column != t.column; ! $ || n || o ? (f.moveCursorToPosition(e), $ = i, A = {
x: v,
y: w
...
a / r <= 2 && (h.column += s.x.left < s.x.right ? -3 : 2),
l / n <= 1 && (h.row += s.y.top < s.y.bottom ? -1 : 1);
var u = e.row != h.row,
d = e.column != h.column,
g = !t || e.row != t.row;
...
function i() {
y = f.selection.toOrientedRange(),
m = f.session.addMarker(y, "ace_selection", f.getSelectionStyle()),
f.clearSelection(),
...
b = setInterval(t, 20),
L = 0,
s.addListener(document, "mousemove", u)
}
function n() {
clearInterval(b),
f.session.removeMarker(m),
m = null,
f.selection.fromOrientedRange(y),
f.isFocused() && !k && f.$resetCursorStyle(),
y = null,
C = null,
L = 0,
x = null,
$ = null,
s.removeListener(document, "mousemove", u)
}
function u() {
...
var r = "none";
return i && t.indexOf(n) >= 0 ? r = "copy": ["move", "copymove", "linkmove", "all", "uninitialized"].indexOf(n) >= 0 ? r = "move": t.indexOf(n) >= 0 && (r = "copy"),
r
}
var f = e.editor,
p = o.createElement("img");
p.src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",
a.isOpera && (p.style.cssText = "width:1px;height:1px;position:fixed;top:0;left:0;z-index:2147483647;opacity:0;"); ["dragWait", "dragWaitEnd", "startDrag", "dragReadyEnd", "onMouseDrag"].forEach((function(t) {
e[t] = this[t]
}), this),
...
a.isOpera && (f.container.appendChild(p), p.scrollTop = 0),
i.setDragImage && i.setDragImage(p, 0, 0),
a.isOpera && f.container.removeChild(p),
i.clearData(),
...
var t = e.dataTransfer.dropEffect; ! S && "move" == t && f.session.remove(f.getSelectionRange()),
f.$resetCursorStyle()
}
...
if (!f.getReadOnly() && d(e.dataTransfer)) return v = e.clientX,
w = e.clientY,
m || i(),
L++,
e.dataTransfer.dropEffect = S = g(e),
s.preventDefault(e)
},
...
s.addListener(E, "dragstart", this.onDragStart.bind(e)),
s.addListener(E, "dragend", this.onDragEnd.bind(e)),
s.addListener(E, "dragenter", this.onDragEnter.bind(e)),
s.addListener(E, "dragover", this.onDragOver.bind(e)),
s.addListener(E, "dragleave", this.onDragLeave.bind(e)),
s.addListener(E, "drop", this.onDrop.bind(e));
var R = null
}
function r(e, t, i, n) {
return Math.sqrt(Math.pow(i - e, 2) + Math.pow(n - t, 2))
...
if (a.isWebKit) this.cancelDrag = !0,
...
"Pallete"]] : ["span"]), v.firstChild)
},
r = function(r) {
var o = r.target.getAttribute("action");
if ("more" == o || !i) return i = !i,
n();
"paste" == o ? e.readText().then((function(e) {
t.execCommand(o, e)
})) : o && ("cut" != o && "copy" != o || (e ? e.writeText(t.getCopyText()) : document.execCommand("copy")), t.execCommand(o)),
...
v.style.top = n.pageY - r.top - 3 + "px",
v.style.right = "10px",
v.style.display = "",
v.firstChild.style.display = "none",
t.on("input", a)
...
i = e.contains(p.row, p.column); ! e.isEmpty() && i || (t.selection.moveToPosition(p), t.selection.selectWord()),
w = "wait",
s()
}
...
var i = e.touches;
if (g || i.length > 1) return clearTimeout(g),
g = null,
u = -1,
void(w = "zoom");
...
f = a.clientX,
v = a.clientY;
Math.abs(l - f) + Math.abs(h - v) > r && (u = -1),
l = e.clientX = f,
h = e.clientY = v,
C = S = 0;
var k = new n(e, t);
if (p = k.getDocumentPosition(), s - u < 500 && 1 == i.length && !b) y++,
e.preventDefault(),
e.button = 0,
function() {
g = null,
...
_ < 3.5 && T < 3.5 && (w = _ > T ? "cursor": "anchor"),
w = T < 3.5 ? "anchor": _ < 3.5 ? "cursor": "scroll",
g = setTimeout(c, 450)
}
u = s
})),
r.addListener(e, "touchend", (function(e) {
m = t.$mouseHandler.isMousePressed = !1,
f && clearInterval(f),
"zoom" == w ? (w = "", b = 0) : g ? (t.selection.moveToPosition(p), b = 0, s()) : "scroll" == w ? (b += 60, f = setInterval((function() {
b--<=0 && (clearInterval(f), f = null),
Math.abs(C) < .01 && (C = 0),
Math.abs(S) < .01 && (S = 0),
b < 20 && (C *= .9),
b < 20 && (S *= .9);
var e = t.session.getScrollTop();
t.renderer.scrollBy(10 * C, 10 * S),
e == t.session.getScrollTop() && (b = 0)
}), 10), a()) : s(),
clearTimeout(g),
g = null
})),
...
u.wheelX = o,
u.wheelY = s,
10 * Math.abs(o) < Math.abs(s) && (o = 0),
10 * Math.abs(s) < Math.abs(o) && (s = 0),
0 != c && (C = o / c, S = s / c),
t._emit("mousewheel", u),
u.propagationStopped || (C = S = 0)
} else {
var f = new n(e, t).getDocumentPosition();
"cursor" == w ? t.selection.moveCursorToPosition(f) : "anchor" == w && t.selection.setSelectionAnchor(f.row, f.column),
t.renderer.scrollCursorIntoView(f),
e.preventDefault()
}
}
}))
...
r.src = e,
i.appendChild(r),
r.onload = r.onreadystatechange = function(e, i) { ! i && r.readyState && "loaded" != r.readyState && "complete" != r.readyState || (r = r.onload = r.onreadystatechange = null, i || t())
}
},
...
var s = l[t + "Path"];
return null == s ? s = l.basePath: "/" == n && (t = n = ""),
s && "/" != s.slice(-1) && (s += "/"),
...
var h = function() { ! l.basePath && !l.workerPath && !l.modePath && !l.themePath && !Object.keys(l.$moduleUrls).length && (console.error("Unable to infer path to ace from script src,", "use ace.config.set('basePath', 'path') to enable dynamic loading of modes and themes", "or with webpack use ace/webpack-resolver"), h = function() {})
};
t.init = function(o) {
if (c && c.document) {
...
u = (h && h.ownerDocument || document).getElementsByTagName("script"), d = 0; d < u.length; d++) {
var g = u[d],
f = g.src || g.getAttribute("src");
if (f) {
for (var p = g.attributes,
m = 0,
v = p.length; m < v; m++) {
var w = p[m];
...
new s(this),
new c(this);
var i = function(t) { (!document.hasFocus || !document.hasFocus() || !e.isFocused() && document.activeElement == (e.textInput && e.textInput.getElement())) && window.focus(),
e.focus()
},
...
r.isIE && e.renderer.scrollBarV && (n.addListener(e.renderer.scrollBarV.element, "mousedown", i), n.addListener(e.renderer.scrollBarH.element, "mousedown", i)),
...
o = e.renderer; ! r.isEmpty() && r.insideStart(n.row, n.column) ? o.setCursorStyle("default") : o.setCursorStyle("")
}
}))
}; (function() {
...
s.state = "",
s.isMousePressed = o.$isMousePressed = !1,
...
s.$onCaptureMouseMove = c,
s.releaseMouse = n.capture(this.editor.container, c, l);
...
h.defineOptions(u.prototype, "mouseHandler", {
scrollSpeed: {
initialValue: 2
},
dragDelay: {
...
c = this.$handlers.length; c--&&!((o = this.$handlers[c].handleKeyboard(this.$data, e, t, i, n)) && o.command && ((s = "null" == o.command || a.exec(o.command, this.$editor, o.args, n)) && n && -1 != e && 1 != o.passEvent && 1 != o.command.passEvent && r.stopEvent(n), s)););
return ! s && -1 == e && (o = {
...
x = null,
$ = [];
if (!n) for (S = 0, n = []; S < i; S++) n[S] = s(e[S]);
for (c = a, l = !1, !1, h = !1, u = !1, x = 0; x < i; x++) {
if (f = v, $[x] = p = o(e, n, $, x), w = 240 & (v = r[f][p]), v &= 15, t[x] = m = r[v][5], w > 0) if (16 == w) {
for (S = b; S < x; S++) t[S] = 1;
b = -1
} else b = -1;
if (r[v][6]) - 1 == b && (b = x);
...
if (u) for (S = 0; S < i; S++) if (n[S] == C) {
t[S] = a;
for (var A = S - 1; A >= 0 && n[A] == k; A--) t[A] = a
}
}
function r(e, t, i) {
if (! (c < e)) if (1 != e || a != f || h) for (var n, r, o, s, l = i.length,
u = 0; u < l;) {
if (t[u] >= e) {
for (n = u + 1; n < l && t[n] >= e;) n++;
for (r = u, o = n - 1; r < o; r++, o--) s = i[r],
i[r] = i[o],
i[o] = s;
u = n
}
...
h = !1,
u = !1,
d = [[0, 3, 0, 1, 0, 0, 0], [0, 3, 0, 1, 2, 2, 0], [0, 3, 0, 17, 2, 0, 1], [0, 3, 5, 5, 4, 1, 0], [0, 3, 21, 21, 4, 0, 1], [0, 3, 5, 5, 4, 2, 0]],
...
s[s.length - 1] === t.DOT && (h[s.length - 1] = t.B),
"‫" === s[0] && (h[0] = t.RLE);
...
for (var i = !1,
n = 0; n < e.length; n++) t[n] = s(e.charAt(n)),
!i && (t[n] == m || t[n] == S || t[n] == w) && (i = !0);
return i
},
...
var e = 0,
t = this.session.$screenRowCache;
if (t.length) for (var i, n = this.session.$getRowCacheIndex(t, this.currentRow); this.currentRow - e > 0 && (i = this.session.$getRowCacheIndex(t, this.currentRow - e - 1)) === n;) n = i,
e++;
...
o && (void 0 === t && (t = this.getSplitIndex()), t > 0 && o.length ? (this.wrapIndent = o.indent, this.wrapOffset = this.wrapIndent * this.charWidths[n.L], this.line = t < o.length ? this.line.substring(o[t - 1], o[t]) : this.line.substring(o[o.length - 1])) : this.line = this.line.substring(0, o[t])),
...
s = 0; ! this.session.getOverwrite() && e <= t && o[r] % 2 != 0 && r++;
for (var a = 0; a < r; a++) s += this.charWidths[o[a]];
return ! this.session.getOverwrite() && e > t && o[r] % 2 == 0 && (s += this.charWidths[o[r]]),
this.wrapIndent && (s += this.isRtlDir ? -1 * this.wrapOffset: this.wrapOffset),
this.isRtlDir && (s += this.rtlLineOffset),
s
},
...
u = 0;
this.wrapIndent && (s += this.isRtlDir ? -1 * this.wrapOffset: this.wrapOffset);
for (var d, g = 0; g < r.length; g++) d = n.logicalFromVisual[g],
i = r[g],
(l = d >= a && d < c) && !h ? u = s: !l && h && o.push({
left: u,
width: s - u
}),
s += this.charWidths[i],
...
(this.$cursorChanged || this.$anchorChanged || r != this.$isEmpty || o) && this._emit("changeSelection")
}
},
...
return r ? (n = r.start.row, i = r.end.row) : i = n,
!0 === t ? new s(n, 0, i, this.session.getLine(i).length) : new s(n, 0, i + 1, 0)
},
...
var n = e.column,
r = e.column + t;
return i < 0 && (n = e.column - t, r = e.column),
this.session.isTabStop(e) && this.doc.getLine(e.row).slice(n, r).split(" ").length - 1 == t
},
...
if (this.session.nonTokenRe.exec(n) && (t += this.session.nonTokenRe.lastIndex, this.session.nonTokenRe.lastIndex = 0, n = i.substring(t)), t >= i.length) return this.moveCursorTo(e, i.length),
...
if (this.session.nonTokenRe.lastIndex = 0, this.session.tokenRe.lastIndex = 0, this.session.nonTokenRe.exec(o) && (i -= this.session.nonTokenRe.lastIndex, o = o.slice(this.session.nonTokenRe.lastIndex), this.session.nonTokenRe.lastIndex = 0), i <= 0) return this.moveCursorTo(t, 0),
this.moveCursorLeft(),
...
rule: l,
groupCount: u - 1
}), l.token = l.token[0]) : (l.tokenArray = l.token, l.token = null, l.onMatch = this.$arrayTokens) : "function" == typeof l.token && !l.onMatch && (l.onMatch = u > 1 ? this.$applyToken: l.token),
u > 1 && (/\\\d/.test(l.regex) ? h = l.regex.replace(/\\([0-9]+)/g, (function(e, t) {
return "\\" + (parseInt(t, 10) + r + 1)
})) : (u = 1, h = this.removeCapturingGroups(l.regex)), !l.splitRegex && "string" != typeof l.token && a.push(l)),
o[r] = c,
r += u,
n.push(h),
...
return n ? n = "]" != a: a ? n = !0 : s ? (i == r.stack && (r.end = c + 1, r.stack = -1), i--) : o && (i++, 1 != o.length && (r.stack = i, r.start = c)),
e
})),
...
for (var w = 0; w < c.length - 2; w++) if (void 0 !== c[w + 1]) {
g = (f = o[s[w]]).onMatch ? f.onMatch(p, n, i, e) : f.token,
f.next && (n = "string" == typeof f.next ? f.next: f.next(n, i), (o = this.states[n]) || (this.reportError("state doesn't exist", n), n = "start", o = this.states[n]), s = this.matchMappings[n], h = m, (a = this.regExps[n]).lastIndex = m),
f.consumeLineEnd && (h = m);
break
}
if (p) if ("string" == typeof g) f && !1 === f.merge || d.type !== g ? (d.type && l.push(d), d = {
type: g,
value: p
}) : d.value += p;
else if (g) {
...
var o = n[r]; (o.next || o.onMatch) && ("string" == typeof o.next && 0 !== o.next.indexOf(t) && (o.next = t + o.next), o.nextState && 0 !== o.nextState.indexOf(t) && (o.nextState = t + o.nextState))
}
this.$rules[t + i] = n
...
if (r) for (var a = 0; a < r.length; a++) r[a] = t + r[a];
else for (var c in r = [], s) r.push(t + c);
...
var u = c.stateName;
u || ("string" != typeof(u = c.token) && (u = u[0] || ""), n[u] && (u += i++)),
n[u] = h,
c.next = u,
r(u)
} else "pop" == h && (c.next = t);
if (c.push && (c.nextState = c.next || c.push, c.next = e, delete c.push), c.rules) for (var d in c.rules) n[d] ? n[d].push && n[d].push.apply(n[d], c.rules[d]) : n[d] = c.rules[d];
...
if (d(r), "}" == l.substring(c.column, c.column + 1)) if (null !== o.$findOpeningBracket("}", {
column: c.column + 1,
row: c.row
...
if (!o.isMultiLine() && "{" == s) {
if (d(i), "}" == r.doc.getLine(o.start.row).substring(o.end.column, o.end.column + 1)) return o.end.column++,
o;
...
if (")" == c.substring(a.column, a.column + 1)) if (null !== n.$findOpeningBracket(")", {
column: a.column + 1,
row: a.row
...
if (!r.isMultiLine() && "(" == o && (d(i), ")" == n.doc.getLine(r.start.row).substring(r.start.column + 1, r.start.column + 2))) return r.end.column++,
r
})),
...
if (!r.isMultiLine() && o.hasOwnProperty(s) && (d(i), n.doc.getLine(r.start.row).substring(r.start.column + 1, r.start.column + 2) == s)) return r.end.column++,
r
}))
};
...
this.isAutoInsertedClosing(r, o, n.autoInsertedLineEnd[0]) || (n.autoInsertedBrackets = 0),
n.autoInsertedRow = r.row,
n.autoInsertedLineEnd = i + o.substr(r.column),
n.autoInsertedBrackets++
},
f.recordMaybeInsert = function(e, t, i) {
var r = e.getCursorPosition(),
o = t.doc.getLine(r.row);
this.isMaybeInsertedClosing(r, o) || (n.maybeInsertedBrackets = 0),
n.maybeInsertedRow = r.row,
n.maybeInsertedLineStart = o.substr(0, r.column) + i,
n.maybeInsertedLineEnd = o.substr(r.column),
n.maybeInsertedBrackets++
},
...
if (Array.isArray(this.lineCommentStart)) m = this.lineCommentStart.map(c.escapeRegExp).join("|"),
f = this.lineCommentStart[0];
else m = c.escapeRegExp(this.lineCommentStart),
...
if (i) {
var n = i[1].length,
r = i[0].length; ! g(e, n, r) && " " == i[0][r - 1] && r--,
...
b = function(e, t) {
var i; (i = e.match(v)) && o.removeInLine(t, e.length - i[0].length, e.length),
(i = e.match(m)) && o.removeInLine(t, i[1].length, i[0].length)
},
y = function(e, i) {
...
d && t.remove(d),
u && (t.remove(u), o = u.start.row, s = -r.start.length)
} else s = r.start.length,
o = i.start.row,
t.insert(i.end, r.end),
t.insert(i.start, r.start);
c.start.row == o && (c.start.column += s),
c.end.row == o && (c.end.column += s),
...
for (var t in this.$embeds = [], this.$modes = {},
e) if (e[t]) {
var i = e[t],
r = i.prototype.$id,
o = n.$modes[r];
...
if (!a[0] && a[1]) return t[0] = a[1],
(s = this.$modes[this.$embeds[o]])[e].apply(s, t)
}
...
i = [];
for (var n in t) for (var r = t[n], o = 0, s = r.length; o < s; o++) if ("string" == typeof r[o].token) / keyword | support | storage / .test(r[o].token) && i.push(r[o].regex);
else if ("object" == typeof r[o].token) for (var a = 0,
c = r[o].token.length; a < c; a++) if (/keyword|support|storage/.test(r[o].token[a])) {
...
e.splice.apply(e, s),
e[n] = o.substring(0, r) + e[n],
e[n + t.lines.length - 1] += o.substring(r)
}
break;
case "remove":
var a = t.end.column,
...
var i = {};
return e >= this.document.getLength() ? (i.row = Math.max(0, this.document.getLength() - 1), i.column = this.document.getLine(i.row).length) : e < 0 ? (i.row = 0, i.column = 0) : (i.row = e, i.column = Math.min(this.document.getLine(i.row).length, Math.max(0, t))),
t < 0 && (i.column = 0),
i
}
}).call(o.prototype)
...
var i = 0; (e = Math.min(Math.max(e, 0), this.getLength())) < this.getLength() ? (t = t.concat([""]), i = 0) : (t = [""].concat(t), e--, i = this.$lines[e].length),
...
0 === t.length && e.isEmpty() ? e.start: t == this.getTextRange(e) ? e.end: (this.remove(e), t ? this.insert(e.start, t) : e.start)
},
...
var i = "insert" == e.action; (i ? e.lines.length <= 1 && !e.lines[0] : !s.comparePoints(e.start, e.end)) || (i && e.lines.length > 2e4 ? this.$splitAndapplyLargeDelta(e, 2e4) : (r(this.$lines, e, t), this._signal("change", e)))
},
...
else if ("remove" == e.action) this.lines.splice(t, i + 1, null),
...
if (this.regExp) for (var s = o.firstRow,
a = o.lastRow,
c = s; c <= a; c++) {
var l = this.cache[c];
...
var i = t[t.length - 1];
this.range = new r(t[0].start.row, t[0].start.column, i.end.row, i.end.column),
...
return s.splice(s.indexOf(this) + 1, 0, l),
l
},
...
if ("insert" == e.action) for (var c = r - n,
l = -t.column + i.column; s < a; s++) {
...
h.end.column == t.column && l > 0 && s < a - 1 && h.end.column > h.start.column && h.end.column == o[s + 1].start.column && (h.end.column -= l),
h.end.column += l,
h.end.row += c
}
} else for (c = n - r, l = t.column - i.column; s < a; s++) {
if ((h = o[s]).start.row > r) break;
h.end.row < r && (n < h.end.row || n == h.end.row && t.column < h.end.column) ? (h.end.row = n, h.end.column = t.column) : h.end.row == r ? h.end.column <= i.column ? (c || h.end.column > t.column) && (h.end.column = t.column, h.end.row = t.row) : (h.end.column += l, h.end.row += c) : h.end.row > r && (h.end.row += c),
h.start.row < r && (n < h.start.row || n == h.start.row && t.column < h.start.column) ? (h.start.row = n, h.start.column = t.column) : h.start.row == r ? h.start.column <= i.column ? (c || h.start.column > t.column) && (h.start.column = t.column, h.start.row = t.row) : (h.start.column += l, h.start.row += c) : h.start.row > r && (h.start.row += c)
}
if (0 != c && s < a) for (; s < a; s++) {
var h; (h = o[s]).start.row += c,
h.end.row += c
}
}
}).call(r.prototype),
...
i = e.start.column,
n = 0,
o = -1; n < this.subFolds.length && 1 == (o = this.subFolds[n].range.compare(t, i)); n++);
...
s = !1;
e instanceof o ? i = e: (i = new o(t, e)).collapseChildren = t.collapseChildren,
...
u && !u.range.isStart(a, c) && this.removeFold(u),
d && !d.range.isEnd(l, h) && this.removeFold(d);
...
return s || (p = this.$addFoldLine(new r(this.$foldData, i))),
...
var s = t.split(e.start.row, e.start.column); (o = s.folds).shift(),
...
else for (var o = r; o.length;) this.expandFolds(o),
...
if (n.isEmpty()) {
var r = n.start;
if (t = this.getFoldAt(r.row, r.column)) return void this.expandFold(t); (i = this.findMatchingBracket(r)) ? 1 == n.comparePoint(i) ? n.end = i: (n.start = i, n.start.column++, n.end.column--) : (i = this.findMatchingBracket({
row: r.row,
column: r.column + 1
...
return l.end.row = r.getCurrentTokenRow(),
l.end.column = r.getCurrentTokenColumn() + o.value.length - 2,
l
}
},
...
if (n) {
t = t || this.getLength();
for (var r = e = e || 0; r < t; r++) if (null == n[r] && (n[r] = this.getFoldWidget(r)), "start" == n[r]) {
...
if (s && !s.isMultiLine() && (o = this.getFoldAt(s.start.row, s.start.column, 1)) && s.isEqual(o.range)) return this.removeFold(o),
o;
if (t.siblings) {
...
var t = this.$updateInternalDataOnChange(e); ! this.$fromUndo && this.$undoManager && (t && t.length && (this.$undoManager.add({
action: "removeFolds",
folds: t
},
this.mergeUndoDeltas), this.mergeUndoDeltas = !0), this.$undoManager.add(e, this.mergeUndoDeltas), this.mergeUndoDeltas = !0, this.$informUndoManager.schedule()),
...
} else for (o = 0; o < n.length && !((r += n[o].value.length) >= t); o++);
...
return n ? (this.$frontMarkers[r] = o, this._signal("changeFrontMarker")) : (this.$backMarkers[r] = o, this._signal("changeBackMarker")),
r
},
...
return e.id = i,
e.inFront = !!t,
t ? (this.$frontMarkers[i] = e, this._signal("changeFrontMarker")) : (this.$backMarkers[i] = e, this._signal("changeBackMarker")),
e
}
},
...
this.$modes[n] && !i ? this.$onChangeMode(this.$modes[n]) : e && e.Mode && (e = new e.Mode(i), i || (this.$modes[n] = e, e.$id = n), this.$onChangeMode(e)),
t && t()
}.bind(this)),
...
null == i[c] && (i[c] = this.$getStringScreenWidth(t[c])[0]),
i[c] > n && (n = i[c])
}
this.screenWidth = n
}
...
var n = e[i]; ("insert" == n.action || "remove" == n.action) && this.doc.applyDelta(n)
...
if (!i) {
this.remove(e);
var s = e.start.row - e.end.row; (l = s ? -e.end.column: e.start.column - e.end.column) && (o.start.row == e.end.row && o.start.column > e.end.column && (o.start.column += l), o.end.row == e.end.row && o.end.column > e.end.column && (o.end.column += l)),
s && o.start.row >= e.end.row && (o.start.row += s, o.end.row += s)
}
...
return (e = e.clone()).start.row == a.row && (e.start.column += l),
e.end.row == a.row && (e.end.column += l),
e.start.row += s,
e.end.row += s,
e
})))
...
s < n && "\t" == o.charAt(s) ? (i.start.column = s, i.end.column = s + 1) : (i.start.column = 0, i.end.column = s),
this.remove(i)
}
},
...
var l = this.$foldData;
c = this.getFoldsInRange(e),
this.removeFolds(c);
var h = 0;
if (p = this.getFoldLine(r.row)) {
p.addRemoveChars(r.row, r.column, n.column - r.column),
p.shiftRow(-a);
var u = this.getFoldLine(o);
u && u !== p && (u.merge(p), p = u),
h = l.indexOf(p) + 1
}
for (; h < l.length; h++) { (p = l[h]).start.row >= r.row && p.shiftRow(-a)
}
s = o
} else {
var d = Array(a);
...
0 == f ? (p = p.split(n.row, n.column)) && (p.shiftRow(a), p.addRemoveChars(s, 0, r.column - n.column)) : -1 == f && (p.addRemoveChars(o, 0, r.column - n.column), p.shiftRow(a)),
h = l.indexOf(p) + 1
}
for (; h < l.length; h++) {
var p; (p = l[h]).start.row >= o && p.shiftRow(a)
}
} else a = Math.abs(e.start.column - e.end.column),
"remove" === i && (c = this.getFoldsInRange(e), this.removeFolds(c), a = -a),
(p = this.getFoldLine(o)) && p.addRemoveChars(o, n.column, a);
...
var c;
if (null != e) { (c = this.$getDisplayTokens(e, r.length))[0] = t;
...
if (9 == s) {
n = this.getScreenTabSize(r.length + i),
r.push(11);
...
if (u && h >= 0) {
a = l[h],
o = this.$docRowCache[h];
var d = e > l[u - 1]
} else d = !u;
for (var g = this.getLength() - 1, f = this.getNextFoldLine(o), p = f ? f.start.row: 1 / 0; a <= e && !(a + (c = this.getRowLength(o)) > e || o >= g);) a += c,
++o > p && (o = f.end.row + 1, p = (f = this.getNextFoldLine(o, f)) ? f.start.row: 1 / 0),
d && (this.$docRowCache.push(o), this.$screenRowCache.push(a));
if (f && f.start.row <= o) n = this.getFoldDisplayLine(f),
o = f.start.row;
else {
if (a + c <= e || o > g) return {
row: g,
...
s += this.$getStringScreenWidth(n, t - m)[1],
...
t = i.column;
var n, r = 0,
o = null; (n = this.getFoldAt(e, t, 1)) && (e = n.start.row, t = n.start.column);
var s, a = 0,
c = this.$docRowCache,
...
r += this.getRowLength(a),
a = s,
u && (this.$docRowCache.push(a), this.$screenRowCache.push(r))
}
var f = "";
...
n = 0,
r = (a = 0, (t = this.$foldData[a++]) ? t.start.row: 1 / 0); n < i;) {
var o = this.$wrapData[n];
e += o ? o.length + 1 : 1,
++n > r && (n = t.end.row + 1, r = (t = this.$foldData[a++]) ? t.start.row: 1 / 0)
} else {
e = this.getLength();
for (var s = this.$foldData,
a = 0; a < s.length; a++) e -= (t = s[a]).end.row - t.start.row
}
...
s.defineOptions(f.prototype, "session", {
wrap: {
set: function(e) {
...
wrapMethod: {
set: function(e) { (e = "auto" == e ? "text" != this.$mode.type: "text" != e) != this.$wrapAsCode && (this.$wrapAsCode = e, this.$useWrapMode && (this.$useWrapMode = !1, this.setUseWrapMode(!0)))
},
initialValue: "auto"
},
indentedSoftWrap: {
...
tabSize: {
set: function(e) { (e = parseInt(e)) > 0 && this.$tabSize !== e && (this.$modified = !0, this.$rowLengthCache = [], this.$tabSize = e, this._signal("changeTabSize"))
},
initialValue: 4,
handlesSet: !0
},
...
return n = new o(e, i, r, s),
!(i == s && t.start && t.start.start && 0 != t.skipCurrent && n.isEqual(t.start)) || (n = null, !1)
})),
n
},
...
for (var d = 0; d < l; d++) if (-1 == r[u + d].search(a[d])) continue e;
var g = r[u],
f = r[u + l - 1],
...
for (s = s.slice(v, d + 1), v = 0, d = s.length; v < d; v++) s[v].start.row += i.start.row,
...
if (0 != t.wrap) for (i = c, a = s.row; i >= a; i--) if (u(i, Number.MAX_VALUE, e)) return
}
};
else l = function(e) {
var i = s.row;
if (!u(i, s.column, e)) {
for (i += 1; i <= c; i++) if (u(i, 0, e)) return;
if (0 != t.wrap) for (i = a, c = s.row; i <= c; i++) if (u(i, 0, e)) return
}
};
...
c = a.search(i[0]);
if (! (!n && c < r || -1 === c)) {
for (var l = 1; l < h; l++) if (-1 == (a = e.getLine(s + l)).search(i[l])) return;
...
return e.$keyChain && (e.$keyChain += " " + r, o = this.commandKeyBinding[e.$keyChain] || o),
...
if (!this.$inReplay) return e && e._emit("changeStatus"),
...
a > 0 ? (e.selection.moveCursorTo(i.row, i.column), e.selection.selectTo(i.row, i.column + a)) : (o = e.session.doc.getLine(i.row).length > o ? o + 1 : o, e.selection.moveCursorTo(i.row, o))
},
multiSelectAction: "forEach",
readOnly: !0
},
...
for (var o = 0; o < n.length; o++) o == n.length - 1 && (n[o].end.row !== t || n[o].end.column !== i) && r.push(new s(n[o].end.row, n[o].end.column, t, i)),
0 === o ? (0 !== n[o].start.row || 0 !== n[o].start.column) && r.push(new s(0, 0, n[o].start.row, n[o].start.column)) : r.push(new s(n[o - 1].end.row, n[o - 1].end.column, n[o].start.row, n[o].start.column));
...
"object" == typeof document && (this.textInput = new a(e.getTextAreaContainer(), this), this.renderer.textarea = this.textInput.getElement(), this.$mouseHandler = new c(this), new l(this)),
...
r = this.renderer.layerConfig; (n.start.row >= r.lastRow || n.end.row <= r.firstRow) && this.renderer.scrollSelectionIntoView(this.selection.anchor, this.selection.lead)
}
...
2 == i.length && (0 == g.comparePoints(i[0].end, i[1].start) ? i = [g.fromPoints(i[0].start, i[1].end)] : 0 == g.comparePoints(i[0].start, i[1].end) && (i = [g.fromPoints(i[1].start, i[0].end)])),
t.$bracketHighlight = {
ranges: i,
...
r = n.getCurrentToken();
if (!r || !/\b(?:tag-open|tag-name)/.test(r.type)) return t.removeMarker(t.$tagHighlight),
...
if (!r) return t.removeMarker(t.$tagHighlight),
void(t.$tagHighlight = null);
var c = n.getCurrentTokenRow(),
l = n.getCurrentTokenColumn(),
h = new g(c, l, c, l + r.value.length),
u = t.$backMarkers[t.$tagHighlight];
t.$tagHighlight && null != u && 0 !== h.compareRange(u.range) && (t.removeMarker(t.$tagHighlight), t.$tagHighlight = null),
t.$tagHighlight || (t.$tagHighlight = t.addMarker(h, "ace_bracket", "text"))
}
}
}), 50)
}
...
if (this.$highlightActiveLine && ("line" == this.$selectionStyle && this.selection.isMultiLine() || (e = this.getCursorPosition()), this.renderer.theme && this.renderer.theme.$selectionColorConflict && !this.selection.isEmpty() && (e = !1), this.renderer.$maxLines && 1 === this.session.getLength() && !(this.renderer.$minLines > 1) && (e = !1)), t.$highlightLineMarker && !e) t.removeMarker(t.$highlightLineMarker.id),
...
var c = o[a];
c.isEmpty() || n.remove(c),
n.insert(c.start, r[a])
}
}
},
...
if (this.session.getOverwrite() && -1 == e.indexOf("\n")) { (s = new g.fromPoints(r, r)).end.column += e.length,
...
t < r.length ? (i = r.charAt(t) + r.charAt(t - 1), n = new g(e.row, t - 1, e.row, t + 1)) : (i = r.charAt(t - 1) + r.charAt(t - 2), n = new g(e.row, t - 2, e.row, t)),
...
for (c = a % s;
" " == n[t.start.column - 1] && c;) t.start.column--,
c--;
...
c *= Math.pow(10, a),
s !== o.end && i < s ? e *= Math.pow(10, o.end - i - 1) : e *= Math.pow(10, o.end - i),
c += e;
var l = (c /= Math.pow(10, a)).toFixed(a),
h = new g(t, o.start, t, o.end);
this.session.replace(h, l),
this.moveCursorTo(t, Math.max(o.start + 1, i + l.length - o.value.length))
}
...
c = a + t.length,
s >= a && s <= c && (i = t, l.selection.clearSelection(), l.moveCursorTo(e, a + n), l.selection.selectTo(e, c + n)),
a = c
}));
for (var h, u = this.$toggleWordPairs,
d = 0; d < u.length; d++) for (var g = u[d], f = 0; f <= 1; f++) {
var p = +!f,
...
var t = g[p];
return e.toUpperCase() == e ? t = t.toUpperCase() : e.charAt(0).toUpperCase() == e.charAt(0) && (t = t.substr(0, 0) + g[p].charAt(0).toUpperCase() + t.substr(1)),
t
})), this.insert(h), h = "")
}
},
...
for (h--, a = this.session.$moveLines(d, g, t ? 0 : e), t && -1 == e && (u = h + 1); u <= h;) s[u].moveBy(a, 0),
u++;
t || (a = 0),
c += a
}
...
r = e * Math.floor(n.height / n.lineHeight); ! 0 === t ? this.selection.$moveSelection((function() {
...
do {
if (o.value.match(/[{}()\[\]]/g)) {
for (; h < o.value.length && !c; h++) if (u[o.value[h]]) switch (a = u[o.value[h]] + "." + o.type.replace("rparen", "lparen"), isNaN(l[a]) && (l[a] = 0), o.value[h]) {
case "(":
case "[":
case "{":
l[a]++;
...
s = e.layerConfig,
a = o.top - s.offset;
null != (n = o.top >= 0 && a + t.top < 0 || !(o.top < s.height && o.top + t.top + s.lineHeight > window.innerHeight) && null) && (r.style.top = a + "px", r.style.left = o.left + "px", r.style.height = s.lineHeight + "px", r.scrollIntoView(n)),
n = t = null
}
}));
this.setAutoScrollEditorIntoView = function(e) {
...
e && this.$relativeLineNumbers ? C.attach(this) : C.detach(this)
},
initialValue: !0
},
relativeLineNumbers: {
...
if (e && this.renderer.placeholderNode) this.renderer.off("afterRender", this.$updatePlaceholder),
...
}.bind(this), this.on("input", this.$updatePlaceholder)),
...
n = "insert" == t.action;
if (i && n) if (p(t.start, e.end) >= 0) l(t, e, -1);
else {
if (! (p(t.start, e.start) <= 0)) return null;
l(e, t, 1)
} else if (i && !n) if (p(t.start, e.end) >= 0) l(t, e, -1);
else {
if (! (p(t.end, e.start) <= 0)) return null;
l(e, t, -1)
} else if (!i && n) if (p(t.start, e.start) >= 0) l(t, e, 1);
else {
if (! (p(t.start, e.start) <= 0)) return null;
l(e, t, 1)
} else if (!i && !n) if (p(t.start, e.start) >= 0) l(t, e, 1);
...
function a(e, t) {
for (var i = e.length; i--;) for (var n = 0; n < t.length; n++) if (!s(e[i], t[n])) {
for (; i < e.length;) {
for (; n--;) s(t[n], e[i]);
n = t.length,
i++
...
var r, o;
if (! (p(t.end, e.start) <= 0)) return p(e.start, t.start) < 0 && (r = e, e = u(e, t.start)),
p(e.end, t.end) > 0 && (o = u(e, t.end)),
h(t.end, e.start, e.end, -1),
o && !r && (e.lines = o.lines, e.start = o.start, e.end = o.end, o = e),
[t, r, o].filter(Boolean);
l(e, t, -1)
}
return [t, e]
}
function l(e, t, i) {
h(e.start, t.start, t.end, i),
h(e.end, t.start, t.end, i)
}
function h(e, t, i, n) {
...
return i.push(s[0].substring(0, a)),
s[0] = s[0].substr(a),
{
start: n(t),
end: r,
...
var s = c(r[o], t);
t = s[0],
2 != s.length && (s[2] ? (r.splice(o + 1, 1, s[1], s[2]), o++) : s[1] || (r.splice(o, 1), o--))
}
...
for (var i = this.selections,
n = i.length; n--;) {
var r = i[n];
if (r.rev < e) return t && (r = i[n + 1]),
r
}
},
...
var n = i.pop(),
r = null;
return this.validateDeltaBoundaries(n, e.getLength(), !0) && (r = e.undoChanges(n, t), this.$redoStack.push(n), this.$syncRev()),
this.$fromUndo = !1,
r
}
},
...
var i = this.getDeltas(this.$redoStackBaseRev, this.$rev + 1); (function(e, t) {
for (var i = 0; i < t.length; i++) for (var n = t[i], r = 0; r < n.length; r++) d(e, n[r])
})(this.$redoStack, i),
...
r = null;
return this.validateDeltaBoundaries(n, e.getLength(), !1) && (r = e.redoChanges(n, t), this.$undoStack.push(n), this.$syncRev()),
this.$fromUndo = !1,
r
},
...
-1 === r.text.indexOf(o) && r.text.push(o);
var a = i.type;
...
break
} (a = this.$lines.get(++c)) ? a.row = l: (a = this.$lines.createCell(l, e, this.session, n), this.$lines.push(a)),
this.$renderCell(a, e, o, l),
l++
}
...
n = t.$firstLineNumber,
r = this.$lines.last() ? this.$lines.last().text: ""; (this.$fixedWidth || t.$useWrapMode) && (r = t.getLength() + n - 1);
var o = i ? i.getWidth(t, r, e) : r.toString().length * e.characterWidth,
s = this.$padding || this.$computePadding(); (o += s.left + s.right) !== this.gutterWidth && !isNaN(o) && (this.gutterWidth = o, this.element.parentNode.style.width = this.element.style.width = Math.ceil(this.gutterWidth) + "px", this._signal("changeGutterWidth", o))
},
...
if (n > i) for (r = this.session.getFoldedRowCount(i + 1, n); r > 0; r--) this.$lines.pop();
...
"start" == m && n == f && n < i.end.row ? p += " ace_closed": p += " ace_open",
c.className != p && (c.className = p);
var v = t.lineHeight + "px";
r.setStyle(c.style, "height", v),
r.setStyle(c.style, "display", "inline-block")
} else c && r.setStyle(c.style, "display", "none");
var w = (d ? d.getText(s, n) : n + l).toString();
return w !== a.data && (a.data = w),
r.setStyle(e.element.style, "height", this.$lines.computeLineHeight(n, t, s) + "px"),
r.setStyle(e.element.style, "top", this.$lines.computeLineTop(n, t, s) + "px"),
e.text = w,
e
},
this.$fixedWidth = !1,
...
for (var a = this.session,
c = i.start.row,
l = i.end.row,
h = c,
u = 0,
d = 0,
g = a.getScreenLastRowColumn(h), f = new n(h, i.start.column, h, d); h <= l; h++) f.start.row = f.end.row = h,
f.start.column = h == c ? i.start.column: a.getRowWrapIndent(h),
f.end.column = g,
u = d,
d = g,
g = h + 1 < l ? a.getScreenLastRowColumn(h + 1) : h == l ? 0 : i.end.column,
this.drawSingleLineMarker(t, f, r + (h == c ? " ace_start": "") + " ace_br" + e(h == c || h == c + 1 && i.start.column, u < d, d > g, h == l), o, h == l ? 0 : 1, s)
},
this.drawMultiLineMarker = function(e, t, i, n, r) {
var o = this.$padding,
s = n.lineHeight,
a = this.$getTop(t.start.row, n),
c = o + t.start.column * n.characterWidth; (r = r || "", this.session.$bidiHandler.isBidiRow(t.start.row)) ? ((l = t.clone()).end.row = l.start.row, l.end.column = this.session.getLine(l.start.row).length, this.drawBidiSingleLineMarker(e, l, i + " ace_br1 ace_start", n, null, r)) : this.elt(i + " ace_br1 ace_start", "height:" + s + "px;right:0;top:" + a + "px;left:" + c + "px;" + (r || ""));
if (this.session.$bidiHandler.isBidiRow(t.end.row)) {
var l; (l = t.clone()).start.row = l.end.row,
l.start.column = 0,
this.drawBidiSingleLineMarker(e, l, i + " ace_br12", n, null, r)
} else {
...
if (this.EOL_CHAR != t) return this.EOL_CHAR = t,
!0
},
this.setPadding = function(e) {
this.$padding = e,
...
this.tabSize = e;
for (var t = this.$tabStrings = [0], i = 1; i < e + 1; i++) if (this.showInvisibles) { (n = this.dom.createElement("span")).className = "ace_invisible ace_invisible_tab",
n.textContent = o.stringRepeat(this.TAB_CHAR, i),
t.push(n)
...
} else l = c = o.stringRepeat(" ", this.tabSize); (n = this.dom.createElement("span")).className = r + s,
n.textContent = c,
this.$tabStrings[" "] = n,
(n = this.dom.createElement("span")).className = r + a,
n.textContent = l,
this.$tabStrings["\t"] = n
}
},
...
for (var c, l = !1,
h = (a = n, (c = this.session.getNextFoldLine(a)) ? c.start.row: 1 / 0); a > h && (a = c.end.row + 1, h = (c = this.session.getNextFoldLine(a, c)) ? c.start.row: 1 / 0), !(a > r);) {
var u = o[s++];
if (u) {
this.dom.removeChildren(u),
this.$renderLine(u, a, a == h && c),
l && (u.style.top = this.$lines.computeLineTop(a, e, this.session) + "px");
var d = e.lineHeight * this.session.getRowLength(a) + "px";
u.style.height != d && (l = !0, u.style.height = d)
}
a++
}
if (l) for (; s < this.$lines.cells.length;) {
...
if (t.firstRow < e.firstRow) for (var r = this.session.getFoldedRowCount(t.firstRow, e.firstRow - 1); r > 0; r--) this.$lines.shift();
if (t.lastRow > e.lastRow) for (r = this.session.getFoldedRowCount(e.lastRow + 1, t.lastRow); r > 0; r--) this.$lines.pop();
...
r.setStyle(l.style, "height", this.$lines.computeLineHeight(o, e, this.session) + "px"),
...
i = e.lastRow,
n = this.$lines; n.getLength();) n.pop();
...
c = this.dom.createFragment(this.element), l = 0; r = a.exec(n);) {
var h = r[1],
u = r[2],
d = r[3],
g = r[4],
...
c.appendChild(s.$tabStrings[m].cloneNode(!0)),
t += m - 1
} else if (u) {
if (s.showInvisibles)(w = this.dom.createElement("span")).className = "ace_invisible ace_invisible_space",
w.textContent = o.stringRepeat(s.SPACE_CHAR, u.length),
c.appendChild(w);
else c.appendChild(this.com.createTextNode(u, this.element))
} else if (d) { (w = this.dom.createElement("span")).className = "ace_invisible ace_invisible_space ace_invalid",
w.textContent = o.stringRepeat(s.SPACE_CHAR, d.length),
c.appendChild(w)
} else if (g) {
t += 1,
(w = this.dom.createElement("span")).style.width = 2 * s.config.characterWidth + "px",
w.className = s.showInvisibles ? "ace_cjk ace_invisible ace_invisible_space": "ace_cjk",
w.textContent = s.showInvisibles ? s.SPACE_CHAR: g,
c.appendChild(w)
} else if (f) {
t += 1,
(w = this.dom.createElement("span")).style.width = 2 * s.config.characterWidth + "px",
...
if (n + u.length < s) a = this.$renderToken(c, a, h, u),
n += u.length;
else {
for (; n + u.length >= s;) a = this.$renderToken(c, a, h, u.substring(0, s - n)),
u = u.substring(s - n),
n = s,
c = this.$createLineElement(),
e.appendChild(c),
c.appendChild(this.dom.createTextNode(o.stringRepeat(" ", i.indent), this.element)),
a = 0,
...
o.textContent = r ? "<hide>": "<click to see more...>",
e.appendChild(o)
},
...
s.className = "ace_invisible ace_invisible_eol",
s.textContent = t == this.session.getLength() - 1 ? this.EOF_CHAR: this.EOL_CHAR,
r.appendChild(s)
}
},
...
type: "fold",
value: e
}) : (a && (r = i.getTokens(t)), r.length &&
function(e, t, i) {
for (var r = 0,
o = 0; o + e[r].value.length < t;) if (o += e[r].value.length, ++r == e.length) return;
for (o != t && ((s = e[r].value.substring(t - o)).length > i - t && (s = s.substring(0, i - t)), n.push({
type: e[r].type,
value: s
}), o = t + s.length, r += 1); o < i && r < e.length;) {
var s; (s = e[r].value).length + o > i ? n.push({
type: e[r].type,
...
for (var t = this.cursors,
i = t.length; i--;) n.setStyle(t[i].style, "opacity", e ? "": "0")
},
this.$startCssAnimation = function() {
for (var e = this.cursors,
t = e.length; t--;) e[t].style.animationDuration = this.blinkInterval + "ms";
setTimeout(function() {
...
this.$measureNode.textContent = o.stringRepeat("X", l),
this.$characterSize = {
width: 0,
height: 0
},
...
return this.$main.textContent = o.stringRepeat(e, l),
...
r.HI_DPI && r.addCssClass(this.container, "ace_hidpi"),
this.setTheme(t),
...
e && (this.$loop.schedule(this.CHANGE_FULL), this.session.$setFontMetrics(this.$fontMetrics), this.scrollBarH.scrollLeft = this.scrollBarV.scrollTop = null, this.onChangeNewLineMode = this.onChangeNewLineMode.bind(this), this.onChangeNewLineMode(), this.session.doc.on("changeNewLineMode", this.onChangeNewLineMode))
},
this.updateLines = function(e, t, i) {
...
s.scrollerWidth = Math.max(0, i - t - this.scrollBarV.getWidth() - this.margin.h),
r.setStyle(this.$gutter.style, "left", this.margin.left + "px");
var c = this.scrollBarV.getWidth() + "px";
r.setStyle(this.scrollBarH.element.style, "right", c),
r.setStyle(this.scroller.style, "right", c),
...
else o += this.lineHeight; (s -= this.scrollLeft) > this.$size.scrollerWidth - c && (s = this.$size.scrollerWidth - c),
s += this.gutterWidth + this.margin.left,
r.setStyle(e, "height", a + "px"),
r.setStyle(e, "width", c + "px"),
r.translate(this.textarea, Math.min(s, this.$size.scrollerWidth - c), Math.min(o, l))
}
}
...
this.session.setScrollTop(Math.max(-h.top, Math.min(this.scrollTop, n - t.scrollerHeight + h.bottom))),
this.session.setScrollLeft(Math.max(-h.left, Math.min(this.scrollLeft, r + 2 * this.$padding - t.scrollerWidth + h.right)));
...
y && (v = y.start.row),
g = e.documentToScreenRow(v, 0),
f = e.getRowLength(v) * b,
w = Math.min(e.screenToDocumentRow(w, 0), e.getLength() - 1),
c = t.scrollerHeight + e.getRowLength(w) * b + f,
p = this.scrollTop - g * b;
var C = 0;
return (this.layerConfig.width != r || s) && (C = this.CHANGE_H_SCROLL),
(s || d) && (C |= this.$updateCachedSize(!0, this.gutterWidth, t.width, t.height), this._signal("scrollbarVisibilityChanged"), d && (r = this.$getLongestLine())),
this.layerConfig = {
width: r,
...
this.session.$bidiHandler && this.session.$bidiHandler.setContentWidth(r - this.$padding),
C
},
...
this.$useTextareaForIME ? (r.addCssClass(this.textarea, "ace_composition"), this.textarea.style.cssText = "", this.$moveTextAreaToCursor(), this.$cursorLayer.element.style.display = "none") : e.markerId = this.session.addMarker(e.markerRange, "ace_composition_marker", "text")
},
...
i.$id && (n.$themeId = i.$id),
r.importCssString(i.cssText, i.cssClass, n.container),
n.theme && r.removeCssClass(n.container, n.theme.cssClass);
...
r.implement(this, s),
this.$createWorkerFromOldConfig = function(t, i, r, o, s) {
...
r.$insertRight = !0,
r.detach(),
r.markerId = i.addMarker(new n(r.row, r.column, r.row, r.column + this.length), this.mainClass, null, !1),
this.others = [],
...
} else if ("remove" === e.action) for (s = this.others.length - 1; s >= 0; s--) {
var c;
a = {
row: (c = this.others[s]).row,
column: c.column + o
...
i.markerId = t.addMarker(new n(i.row, i.column, i.row, i.column + e.length), r, null, !1)
};
...
s && (k = null, S = d.ranges[0] || S, u.removeSelectionMarker(S)),
u.once("mouseup", (function() {
var e = d.toOrientedRange();
k && e.isEmpty() && n(k.cursor, e.cursor) ? d.substractPoint(e.cursor) : (s ? d.substractPoint(S.cursor) : S && (u.removeSelectionMarker(S), d.addRange(S)), d.addRange(e)),
...
g && !c ? d.toSingleRange() : !g && c && (x = d.toOrientedRange(), u.addSelectionMarker(x)),
s ? y = b.documentToScreenPosition(d.lead) : d.moveToPosition(f),
C = {
row: -1,
column: -1
};
...
A(),
clearInterval(L),
u.removeSelectionMarkers($),
$.length || ($ = [d.toOrientedRange()]),
...
l.addListener(i, "keyup", t),
l.addListener(i, "blur", t)
} (e))
}
...
g = e("./edit_session").EditSession; (function() {
...
0 === this.rangeCount && this.inMultiSelectMode && (this.inMultiSelectMode = !1, this._signal("singleSelect"), this.session.$undoSelect = !0, this.rangeList.detach(this.session)),
...
m.cursor = o ? m.start: m.end,
r.push(m)
}
if (d && r.reverse(), !i) {
for (var v = r.length - 1; r[v].isEmpty() && v > 0;) v--;
if (v > 0) for (var w = 0; r[w].isEmpty();) w++;
for (var b = v; b >= w; b--) r[b].isEmpty() && r.splice(b, 1)
}
return r
}
}.call(a.prototype);
var f = e("./editor").Editor; (function() {
...
if (o) for (; g > 0 && h[g].start.row == h[g - 1].end.row;) g--;
d.fromOrientedRange(h[g]),
d.index = g,
this.selection = s.selection = d;
var f = e.exec ? e.exec(this, t || {}) : e(this, t || {}); ! n && void 0 !== f && (n = f),
d.toOrientedRange(h[g])
}
d.detach(),
this.selection = s.selection = c,
this.inVirtualSelectionMode = !1,
c._eventRegistry = u,
c.mergeOverlappingRanges(),
c.ranges[0] && c.fromOrientedRange(c.ranges[0]);
...
var r = this.session.getDocument().getNewLineCharacter(); (e = i.join(r)).length == (i.length - 1) * r.length && (e = "")
...
s = function(e, t, i) {
return d.$options.wrap = !0,
d.$options.needle = t,
d.$options.backwards = -1 == i,
d.find(e)
} (n, o, e);
s && (s.cursor = -1 == e ? s.start: s.end, this.session.unfold(s), this.multiSelect.addRange(s), this.renderer.scrollCursorIntoView(null, .5)),
...
r = o - n.column,
l = c[i] - a;
r > l ? e.insert(n, h.stringRepeat(" ", r - l)) : e.remove(new s(n.row, n.column, n.row, n.column - r + l)),
...
m.join("\n") + "\n"),
g || (l.start.column = 0, l.end.column = m[m.length - 1].length),
this.selection.setRange(l)
}
},
...
set: function(e) {
r(this),
e ? (this.on("changeSession", this.$multiselectOnSessionChange), this.on("mousedown", c)) : (this.off("changeSession", this.$multiselectOnSessionChange), this.off("mousedown", c))
},
value: !0
},
enableBlockSelect: {
...
"use strict";
var n = e("../../range").Range,
r = t.FoldMode = function() {}; (function() {
...
return null == c && (c = e.getFoldWidget(a.row)),
"start" == c && a.row > s.row && (a.row--, a.column = e.getLine(a.row).length),
n.fromPoints(s, a)
}
},
...
this.editor != e && (this.detach(), this.editor = e, e && (e.widgetManager = this, e.renderer.on("beforeRender", this.measureWidgets), e.renderer.on("afterRender", this.renderWidgets)))
},
...
var i = e.start.row,
n = e.end.row - i;
if (0 !== n) if ("remove" == e.action) {
var r = t.splice(i + 1, n); ! t[i] && r[r.length - 1] && (t[i] = r.pop()),
r.forEach((function(e) {
...
if (e) for (t = !1, e.row = i; e.$oldWidget;) e.$oldWidget.row = i,
e = e.$oldWidget
})),
...
return t && (e.$oldWidget = t, t.el && t.el.parentNode && (t.el.parentNode.removeChild(t.el), t._inDocument = !1)),
...
e.el && (r.addCssClass(e.el, "ace_lineWidgetContainer"), e.el.style.position = "absolute", e.el.style.zIndex = 5, t.container.appendChild(e.el), e._inDocument = !0, e.coverGutter || (e.el.style.zIndex = 3), null == e.pixelHeight && (e.pixelHeight = e.el.offsetHeight)),
...
for (var t = this.session.lineWidgets,
i = t && t[e], n = []; i;) n.push(i),
i = i.$oldWidget;
return n
},
...
s.fixedWidth || (s.w = s.el.offsetWidth, s.screenWidth = Math.ceil(s.w / n.characterWidth));
var a = s.h / n.lineHeight;
s.coverLine && ((a -= this.session.getRowLineCount(s.row)) < 0 && (a = 0)),
s.rowCount != a && (s.rowCount = a, s.row < r && (r = s.row))
}
}
...
!0).top;
a.coverLine || (c += i.lineHeight * this.session.getRowLineCount(a.row)),
a.el.style.top = c - i.offset + "px";
var l = a.coverGutter ? 0 : t.gutterWidth;
a.fixedWidth || (l -= t.scrollLeft),
...
s.comparePoints);
r < 0 && (r = -r - 1),
r >= n.length ? r = i > 0 ? 0 : n.length - 1 : 0 === r && i < 0 && (r = n.length - 1);
var o = n[r];
if (o && i) {
if (o.row === t) {
do {
...
if (h) {
var u = h[0];
s.column = (u.pos && "number" != typeof u.column ? u.pos.sc: u.column) || 0,
s.row = u.row,
...
g.className = "error_widget " + l.className,
...
function(e, t) {
var i;
return null !== e ? (d.prototype = r(e), i = new d, d.prototype = null, i[u] = e) : i = f(),
void 0 === t ? i: o(i, t)
}
},
function(e, t, i) {
...
d = void 0 !== /()??/.exec("")[1]; (h || d || u) && (l = function(e) {
var t, i, n, r, s = this,
l = u && s.sticky,
g = o.call(s),
f = s.source,
p = 0,
m = e;
return l && (-1 === (g = g.replace("y", "")).indexOf("g") && (g += "g"), m = String(e).slice(s.lastIndex), s.lastIndex > 0 && (!s.multiline || s.multiline && "\n" !== e[s.lastIndex - 1]) && (f = "(?: " + f + ")", m = " " + m, p++), i = new RegExp("^(?:" + f + ")", g)),
d && (i = new RegExp("^" + f + "$(?!\\s)", g)),
h && (t = s.lastIndex),
n = a.call(l ? i: s, m),
l ? n ? (n.input = n.input.slice(p), n[0] = n[0].slice(p), n.index = s.lastIndex, s.lastIndex += n[0].length) : s.lastIndex = 0 : h && n && (s.lastIndex = s.global ? n.index + n[0].length: t),
d && n && n.length > 1 && c.call(n[0], i, (function() {
...
var n = v(t, !0);
return f(i),
u(Q, n) ? (i.enumerable ? (u(e, D) && e[D][n] && (e[D][n] = !1), i = b(i, {
enumerable: w(0, !1)
...
if (i !== U || !u(Q, n) || u(q, n)) {
var r = G(i, n);
return ! r || !u(Q, n) || u(i, D) && i[D][n] || (r.enumerable = !0),
r
}
},
he = function(e) {
...
i = J(t ? q: m(e)),
n = [];
return N(i, (function(e) { ! u(Q, e) || t && !u(U, e) || n.push(Q[e])
})),
n
}; (c || (L((K = function() {
...
K.prototype[P] || E(K.prototype, P, K.prototype.valueOf),
W(K, "Symbol"),
T[D] = !0
},
function(e, t, i) {
...
} else for (; l > h; h++) if ((e || h in c) && c[h] === i) return e || h || 0;
return ! e && -1
}
};
e.exports = {
...
e.exports = function(e, t) {
var i;
return r(e) && ("function" != typeof(i = e.constructor) || i !== Array && !r(i.prototype) ? n(i) && null === (i = i[o]) && (i = void 0) : i = void 0),
...
return E.call(this)
}), u && !b || A[m] === L || c(A, m, L), d[t] = L, g) if (C = {
values: k("values"),
keys: w ? L: k("keys"),
entries: k("entries")
},
b) for (S in C)(p || $ || !(S in A)) && l(A, S, C[S]);
else n({
target: t,
proto: !0,
forced: p || $
...
h = i(27),
u = l("iterator"),
d = !1; [].keys && ("next" in (o = [].keys()) ? (r = s(s(o))) !== Object.prototype && (n = r) : d = !0),
null == n && (n = {}),
h || c(n, u) || a(n, u, (function() {
return this
})),
e.exports = {
IteratorPrototype: n,
...
return e = r(e),
n(e, a) ? e[a] : "function" == typeof e.constructor && e instanceof e.constructor ? e.constructor.prototype: e instanceof Object ? c: null
}
},
function(e, t, i) {
var n = i(9),
...
var e, t = !1,
i = {};
try { (e = Object.getOwnPropertyDescriptor(Object.prototype, "__proto__").set).call(i, []),
...
c = a && a.versions,
l = c && c.v8;
l ? r = (n = l.split("."))[0] + n[1] : s && (!(n = s.match(/Edge\/(\d+)/)) || n[1] >= 74) && (n = s.match(/Chrome\/(\d+)/)) && (r = n[1]),
e.exports = r && +r
},
function(e, t, i) {
var n = i(6),
...
for (var a, c, l, h = [], d = (e.ignoreCase ? "i": "") + (e.multiline ? "m": "") + (e.unicode ? "u": "") + (e.sticky ? "y": ""), f = 0, p = new RegExp(e.source, d + "g"); (a = u.call(p, n)) && !((c = p.lastIndex) > f && (h.push(n.slice(f, a.index)), a.length > 1 && a.index < n.length && g.apply(h, a.slice(1)), l = a[0].length, f = c, h.length >= o));) p.lastIndex === a.index && p.lastIndex++;
return f === n.length ? !l && p.test("") || h.push("") : h.push(n.slice(f)),
...
for (var $ = 1; $ <= x.length - 1; $++) if (S.push(x[$]), S.length === b) return S;
C = y = k
}
}
return S.push(d.slice(y)),
S
}]
}), !p)
},
...
onMatch: function(e, t, i) {
var n = e[1];
return ("}" == n && i.length || -1 != "`$\\".indexOf(n)) && (e = n),
[e]
}
},
{
...
onMatch: function(e, t, i) {
var n = i.shift();
return n && (n.flag = e.slice(1, -1)),
this.next = n && n.tabstopId ? "start": "",
[n || e]
},
next: "start"
},
...
onMatch: function(e, t, i) {
var n = i.shift();
return this.next = n && n.tabstopId ? "start": "",
[n || e]
},
next: "start"
}],
...
regex: /:\/\w+}/,
onMatch: function(e, t, i) {
return i[0].formatFunction = e.slice(2, -1),
[i.shift()]
},
next: "formatString"
},
...
return "function" == typeof n && (n = this.variables[t](e, t, i)),
null == n ? "": n
},
this.variables = d,
...
var a = t[r];
if ("object" == typeof a) if (t[r] = "", a.changeCase && a.local) {
var c = t[r + 1];
...
if (a) {
if (o = !1, a.fmtString) {
var c = e.indexOf(a, s + 1); - 1 == c && (c = e.length),
a.fmt = e.slice(s + 1, c),
s = c
}
if (a.text) {
var l = this.getVariableValue(t, a.text, r) + "";
a.fmtString && (l = this.tmStrFormat(l, a, t)),
a.formatFunction && (l = this.tmFormatFunction(l, a, t)),
l && !a.ifEnd ? (n.push(l), i(a)) : !l && a.ifEnd && i(a.ifEnd)
...
e.choices && !n.choices && (n.choices = e.choices),
n.push(e);
...
l[d] = u;
var m = g.value;
"string" != typeof m ? m = i(m) : u.fmt && (m = this.tmStrFormat(m, u, e)),
a.splice.apply(a, [h + 1, Math.max(0, p - h)].concat(m, u)),
...
if ("string" == typeof e) {
var t = e.split("\n");
t.length > 1 ? (w = t[t.length - 1].length, v += t.length - 1) : w += e.length,
b += e
...
n.substring && ("js-" == n.substring(0, 3) ? t = "javascript": "css-" == n.substring(0, 4) ? t = "css": "php-" == n.substring(0, 4) && (t = "php"))
}
return t
},
...
i = [t],
n = this.snippetMap;
return n[t] && n[t].includeScopes && i.push.apply(i, n[t].includeScopes),
i.push("_"),
i
},
...
return n && e.tabstopManager && e.tabstopManager.tabNext(),
n
},
...
var t = a[e];
return t && (i = this.findMatchingSnippet(t, o, s)),
!!i
}), this),
!!i && (t && t.dryRun || (e.session.doc.removeInLine(n.row, n.column - i.replaceBefore.length, n.column + i.replaceAfter.length), this.variables.M__ = i.matchBefore, this.variables.T__ = i.matchAfter, this.insertSnippetForSelection(e, i.content), this.variables.M__ = this.variables.T__ = null), !0)
},
this.findMatchingSnippet = function(e, t, i) {
for (var n = e.length; n--;) {
var r = e[n];
if ((!r.startRe || r.startRe.test(t)) && ((!r.endRe || r.endRe.test(i)) && (r.startRe || r.endRe))) return r.matchBefore = r.startRe ? r.startRe.exec(t) : [""],
...
o[t].push(e),
e.tabTrigger && !e.trigger && (!e.guard && /^\w/.test(e.tabTrigger) && (e.guard = "\\b"), e.trigger = s.escapeRegExp(e.tabTrigger)),
(e.trigger || e.guard || e.endTrigger || e.endGuard) && (e.startRe = n(e.trigger, e.guard, !0), e.triggerRe = new RegExp(e.trigger), e.endRe = n(e.endTrigger, e.endGuard, !0), e.endTriggerRe = new RegExp(e.endTrigger))
}
...
if (t[4]) n.content = t[4].replace(/^\t/gm, ""),
i.push(n),
n = {};
else {
var o = t[2],
...
this.onChange = function(e) {
for (var t = "r" == e.action[0], i = this.selectedTabstop || {},
n = i.parents || {},
r = (this.tabstops || []).slice(), o = 0; o < r.length; o++) {
var s = r[o],
a = s == i || n[s.index];
...
var g = this.editor.session; ! this.$inChange && t && 1 == g.getLength() && !g.getValue() && this.detach()
},
this.updateLinkedFields = function() {
var e = this.selectedTabstop;
if (e && e.hasLinkedRanges && e.firstNonLinked) {
this.$inChange = !0;
for (var i = this.editor.session,
n = i.getTextRange(e.firstNonLinked), r = 0; r < e.length; r++) {
var o = e[r];
if (o.linked) {
var s = o.original,
...
i = this.editor.selection.isEmpty(), n = 0; n < this.ranges.length; n++) if (!this.ranges[n].linked) {
...
i = this.index + (e || 1); (i = Math.min(Math.max(i, 1), t)) == t && (i = 0),
...
this.editor.keyBinding.addKeyboardHandler(this.keyboardHandler),
this.selectedTabstop && this.selectedTabstop.choices && this.editor.execCommand("startAutocomplete", {
...
u.tabstop = r,
s.push(u),
r != e ? r.unshift(u) : r[l] = u,
h.fmtString || r.firstNonLinked && n ? (u.linked = !0, r.hasLinkedRanges = !0) : r.firstNonLinked || (r.firstNonLinked = u)
}
r.firstNonLinked || (r.hasLinkedRanges = !1),
r === e && (o.push(r), this.$openTabstops[i] = r),
this.addTabstopMarkers(r),
r.rangeList = r.rangeList || new c,
r.rangeList.$bias = 0,
r.rangeList.addList(r)
}), this),
o.length > 2 && (this.tabstops.length && o.push(o.splice(2, 1)[0]), this.tabstops.splice.apply(this.tabstops, o))
},
...
var t = e.tabstop.indexOf(e); - 1 != t && e.tabstop.splice(t, 1),
-1 != (t = this.ranges.indexOf(e)) && this.ranges.splice(t, 1),
-1 != (t = e.tabstop.rangeList.ranges.indexOf(e)) && e.tabstop.splice(t, 1),
this.editor.session.removeMarker(e.markerId),
e.tabstop.length || (-1 != (t = this.tabstops.indexOf(e.tabstop)) && this.tabstops.splice(t, 1), this.tabstops.length || this.detach())
},
...
t.$maxLines = 4;
var i = new r(t);
return i.setHighlightActiveLine(!1),
...
if (r) {
if (r.x != e.x || r.y != e.y) { (r = e).scrollTop = i.renderer.scrollTop;
...
n !== t.selectedNode && t.selectedNode && c.removeCssClass(t.selectedNode, "ace_selected"),
t.selectedNode = n,
n && c.addCssClass(n, "ace_selected")
}));
var d = function() {
g(-1)
},
...
s.addListener(i.container, "mouseout", d),
i.on("hide", d),
...
for (var o = n.caption || n.value || n.name,
s = o.toLowerCase(), a = (i.filterText || "").toLowerCase(), c = 0, l = 0, h = 0; h <= a.length; h++) if (h != l && (n.matchMask & 1 << h || h == a.length)) {
var u = a.slice(l, h);
l = h;
var d = s.indexOf(u, c);
if (-1 == d) continue;
t(o.slice(c, d), ""),
c = d + u.length,
t(o.slice(d, c), "completion-highlight")
}
return t(o.slice(c, o.length), ""),
n.meta && r.push({
...
u.start.row != e && (i.selection.clearSelection(), u.start.row = u.end.row = e || 0, i.session._emit("changeBackMarker"), i.moveCursorTo(e || 0, 0), i.isOpen && i._signal("select"))
},
...
h > s / 2 && !n && h + t + l > s ? (c.$maxPixelHeight = h - 2 * this.$borderSize, o.style.top = "", o.style.bottom = s - h + "px", i.isTopdown = !1) : (h += t, c.$maxPixelHeight = s - h - .2 * t, o.style.top = h + "px", o.style.bottom = "", i.isTopdown = !0),
o.style.display = "";
var u = e.left;
u + o.offsetWidth > a && (u = a - o.offsetWidth),
o.style.left = u + "px",
this._signal("show"),
r = null,
i.isOpen = !0
...
r = e.length;
0 === r && i();
for (var o = 0; o < r; o++) t(e[o], (function(e, t) {++n === r && i(e, t)
}))
};
var n = /[a-zA-Z_0-9\$\-\u00A2-\u2000\u2070-\uFFFF]/;
...
e.identifierRegexps && e.identifierRegexps.forEach(function(e) { ! t && e && (t = this.retrievePrecedingIdentifier(n, i.column, e))
}.bind(this))
}.bind(this)),
...
o.top += s.top - n.layerConfig.offset,
...
this.changeListener = function(e) {
var t = this.editor.selection.lead; (t.row != this.base.row || t.column < this.base.column) && this.detach(),
...
if (this.completions.filterText) for (var i, n = this.editor.selection.getAllRanges(), r = 0; i = n[r]; r++) i.start.column -= this.completions.filterText.length,
...
this.base = i.doc.createAnchor(n.row, n.column - r.length),
this.base.$insertRight = !0;
var s = [],
a = e.completers.length;
return e.completers.forEach((function(c, l) {
c.getCompletions(e, i, n, r, (function(i, n) { ! i && n && (s = s.concat(n)),
t(null, {
...
return this.base = this.editor.session.doc.createAnchor(i.row, i.column),
this.base.$insertRight = !0,
this.completions = new u(t.matches),
...
return e.getDocTooltip && (n = e.getDocTooltip(i)),
n
...
t.style.top = i.container.style.top,
t.style.bottom = i.container.style.bottom,
t.style.display = "block",
window.innerWidth - n.right < 320 ? n.left < 320 ? i.isTopdown ? (t.style.top = n.bottom + "px", t.style.left = n.left + "px", t.style.right = "", t.style.bottom = "") : (t.style.top = i.container.offsetTop - t.offsetHeight + "px", t.style.left = n.left + "px", t.style.right = "", t.style.bottom = "") : (t.style.right = window.innerWidth - n.left + "px", t.style.left = "") : (t.style.left = n.right + 1 + "px", t.style.right = "")
},
this.hideDocTooltip = function() {
if (this.tooltipTimer.cancel(), this.tooltipNode) {
var e = this.tooltipNode; ! this.editor.isFocused() && document.activeElement == e && this.editor.focus(),
...
this.editor && this.editor.completer == this && this.editor.completer,
this.popup = null
}
}).call(h.prototype),
h.
...
this.filterText = e,
t = (t = this.filterCompletions(t, this.filterText)).sort((function(e, t) {
...
m = a.indexOf(n[f], h + 1);
if ((c = p >= 0 && (m < 0 || p < m) ? p: m) < 0) continue e; (l = c - h - 1) > 0 && (-1 === h && (d += 10), d += l, u |= 1 << f),
h = c
}
}
o.matchMask = u,
...
b = l(f),
y = 0;
if (w && (v = n(v, m > 2 ? arguments[2] : void 0, 2)), null == b || p == Array && s(b)) for (i = new p(t = a(f.length)); t > y; y++) g = w ? v(f[y], y) : f[y],
c(i, y, g);
else for (d = (u = b.call(f)).next, i = new p; ! (h = d.call(u)).done; y++) g = w ? o(u, v, [h.value, y], !0) : h.value,
c(i, y, g);
return i.length = y,
i
}
...
h = "toString" != c.name; (l || h) && n(RegExp.prototype, "toString", (function() {
var e = r(this),
t = String(e.source),
i = e.flags;
...
if (g[l] || s(g, l, u), r[u]) for (var f in o) if (g[f] !== o[f]) try {
s(g, f, o[f])
} catch(e) {
g[f] = o[f]
}
...
u = h(s, 0),
d = 0;
for (t = -1, n = arguments.length; t < n; t++) if (o = -1 === t ? s: arguments[t], v(o)) {
...
for (var t, i, n = s(e), r = a.f, l = o(n), h = {},
u = 0; l.length > u;) void 0 !== (i = r(n, t = l[u++])) && c(h, t, i);
return h
}
})
},
...
t.cssText = '.ace-github .ace_gutter {background: #e8e8e8;color: #AAA;}.ace-github  {background: #fff;color: #000;}.ace-github .ace_keyword {font-weight: bold;}.ace-github .ace_string {color: #D14;}.ace-github .ace_variable.ace_class {color: teal;}.ace-github .ace_constant.ace_numeric {color: #099;}.ace-github .ace_constant.ace_buildin {color: #0086B3;}.ace-github .ace_support.ace_function {color: #0086B3;}.ace-github .ace_comment {color: #998;font-style: italic;}.ace-github .ace_variable.ace_language  {color: #0086B3;}.ace-github .ace_paren {font-weight: bold;}.ace-github .ace_boolean {font-weight: bold;}.ace-github .ace_string.ace_regexp {color: #009926;font-weight: normal;}.ace-github .ace_variable.ace_instance {color: teal;}.ace-github .ace_constant.ace_language {font-weight: bold;}.ace-github .ace_cursor {color: black;}.ace-github.ace_focus .ace_marker-layer .ace_active-line {background: rgb(255, 255, 204);}.ace-github .ace_marker-layer .ace_active-line {background: rgb(245, 245, 245);}.ace-github .ace_marker-layer .ace_selection {background: rgb(181, 213, 255);}.ace-github.ace_multiselect .ace_selection.ace_start {box-shadow: 0 0 3px 0px white;}.ace-github.ace_nobold .ace_line > span {font-weight: normal !important;}.ace-github .ace_marker-layer .ace_step {background: rgb(252, 255, 0);}.ace-github .ace_marker-layer .ace_stack {background: rgb(164, 229, 101);}.ace-github .ace_marker-layer .ace_bracket {margin: -1px 0 0 -1px;border: 1px solid rgb(192, 192, 192);}.ace-github .ace_gutter-active-line {background-color : rgba(0, 0, 0, 0.07);}.ace-github .ace_marker-layer .ace_selected-word {background: rgb(250, 250, 255);border: 1px solid rgb(200, 200, 250);}.ace-github .ace_invisible {color: #BFBFBF}.ace-github .ace_print-margin {width: 0px;background: #e8e8e8;}.ace-github .ace_indent-guide {background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAACCAYAAACZgbYnAAAAE0lEQVQImWP4////f4bLly//BwAmVgd1/w11/gAAAABJRU5ErkJggg==") right repeat-y;}',
e("../lib/dom").importCssString(t.cssText, t.cssClass)
})),
...
onMatch: function(e, t, i) {
return i.unshift(this.next, e.length - 2, t),
"comment"
},
regex: /\-\-\[=*\[/,
next: [{
onMatch: function(e, t, i) {
return e.length == i[1] ? (i.shift(), i.shift(), this.next = i.shift()) : this.next = "",
"comment"
},
regex: /\]=*\]/,
next: "start"
...
onMatch: function(e, t, i) {
return i.unshift(this.next, e.length, t),
"string.start"
},
regex: /\[=*\[/,
next: [{
...
g = t;
for (r.step = -1 === u ? r.stepBackward: r.stepForward; c = r.step();) if ("keyword" === c.type) {
var f = u * a[c.value];
...
return "start" == t && (o = e(s)),
o > 0 ? r + n: o < 0 && r.substr(r.length - n.length) == n && !this.checkOutdent(t, i, "\n") ? r.substr(0, r.length - n.length) : r
},
...
this.$init(),
this.setEditor(e),
n.importCssString(s, "ace_searchbox", e.container)
}; (function() {
...
this.searchRange = e,
e ? this.searchRangeMarker = this.editor.session.addMarker(e, "ace_active-line") : this.searchRangeMarker && (this.editor.session.removeMarker(this.searchRangeMarker), this.searchRangeMarker = null)
},
...
for (var s, a = t.lastIndex = 0; (s = t.exec(r)) && (i++, (a = s.index) <= o && n++, !(i > 999)) && (s[0] || (t.lastIndex = a += 1, !(a >= r.length))););
}
...
t.SearchBox = l,
t.Search = function(e, t) { (e.searchBox || new l(e)).show(e.session.getTextRange(), t)
}
})),
...
for (s = (o = l.slice(2)).length, a = 0; a < s; a++) if ((c = o.charCodeAt(a)) < 48 || c > r) return NaN;
return parseInt(o, n)
}
return + l
};
...
e.exports = function(e, t, i) {
var o, s;
return r && "function" == typeof(o = t.constructor) && o !== i && n(s = o.prototype) && s !== i.prototype && r(e, s),
e
}
},
function(e, t, i) {
...
y), n),
this.isCanDrag = !1,
this.enableDarg = this.enableDarg.bind(this),
this.disableDarg = this.disableDarg.bind(this),
this.handleDragTargetMousedown = this.handleDragTargetMousedown.bind(this),
this.handleDocMousemove = this.handleDocMousemove.bind(this)
}
var t, i, n;
return t = e,
(i = [{
...
key: "init",
value: function() {
document.addEventListener("mouseup", this.disableDarg, !1),
window.addEventListener("blur", this.disableDarg, !1),
this.dargTarget.addEventListener("mousedown", this.handleDragTargetMousedown, !1),
document.addEventListener("mousemove", this.handleDocMousemove, !1)
}
},
{
key: "destory",
value: function() {
document.removeEventListener("mouseup", this.disableDarg, !1),
window.removeEventListener("blur", this.disableDarg, !1),
this.dargTarget.removeEventListener("mousedown", this.handleDragTargetMousedown, !1),
document.removeEventListener("mousemove", this.handleDocMousemove, !1)
}
}]) && b(t.prototype, i),
n && b(t, n),
e
...
A.addEventListener("input", T, !1),
A.addEventListener("input", (e = 500, t = function(e) {
if (!n) {
...
t.unshift(e),
t = t.slice(0, 5),
window.localStorage.setItem("searchStorage", t.join(","))
}
} (t), I(S, t), D()) : (I(S), D())
}
},
...
B = 0,
e.length && e[B].classList.add("current")
},
P = function() {
I(S),
...
s.a.addCompleter({
getCompletions: function(e, t, i, n, r) {
r(null, GetGlobalVars()),
r(null, window.GetServiceFuncs())
}
}),
e.setTheme("ace/theme/".concat(window.localStorage.getItem("currentTheme") || "monokai")),
f(e),
H(e);
...
a.scope = i,
a.snippetText = n,
a.snippet = o.parseSnippetFile(n, a.scope),
o.register(a.snippet, a.scope)
} (0, e.session, "lua", t),
window.aceEditor = e,
e
},
...
window.localStorage.setItem("currentTheme", t),
se(),
function(e) {
e = e || window.localStorage.getItem("currentTheme") || "monokai",
c.call(oe, (function(t) {
t.classList.remove("current"),
t.dataset.theme === e && t.classList.add("current")
}))
} (t),
te.setTheme("ace/theme/".concat(t))
}))
};
function le() {
ae(),
...
window.localStorage.setItem("currentFontSize", t),
Ae(),
function(e) {
e = e || window.localStorage.getItem("currentFontSize") || "14px",
c.call($e, (function(t) {
t.classList.remove("current"),
t.dataset.size === e && t.classList.add("current")
}))
} (t),
Ce.container.style.fontSize = t
}))
};
function Re() {
Ee(),
...
// link.href = imgData;
// link.download = 'D:/screenshot.png';
// link.click();
var dataUrl = canvas.toDataURL('image/png');
var imgB64 = dataUrl.replace(/^data:image\/(png|jpg);base64,/, '');
window.SaveScriptEditorWebViewBG && window.SaveScriptEditorWebViewBG(imgB64)
});
...
var file_e = document.getElementById("fileWrapper"),
file_Te = document.getElementById("fileInner"),
file_Me = document.getElementById("fileBtn"),
file_Oe = function() {
file_Te.classList.remove("show")
},
file_Fe = function() {
file_Me.addEventListener("click", (function() {
file_Te.classList.toggle("show")
}))
};
function file_Ie() {
file_Fe(),
file_e.addEventListener("mouseleave", (function() {
file_Oe()
})),
file_Te.addEventListener("click", (function(e) {
var t = e.target;
file_Oe();
var i = t.dataset.type;
console.log(i);	
...
var help_e = document.getElementById("helpWrapper"),
help_Te = document.getElementById("helpInner"),
help_Me = document.getElementById("helpBtn"),
help_Oe = function() {
help_Te.classList.remove("show")
},
help_Fe = function() {
help_Me.addEventListener("click", (function() {
help_Te.classList.toggle("show")
}))
};
function help_Ie() {
help_Fe(),
help_e.addEventListener("mouseleave", (function() {
help_Oe()
})),
help_Te.addEventListener("click", (function(e) {
var t = e.target;
help_Oe();
var i = t.dataset.type;
console.log(i);	
...
var debug_e = document.getElementById("debugWrapper"),
debug_Me = document.getElementById("debugBtn"),
debug_Fe = function() {
debug_Me.addEventListener("click", (function() {
window.NativeOpenIDLibrary && window.NativeOpenIDLibrary(5001)
}))
};
function debug_Ie() {
debug_Fe()
...
var insert_e = document.getElementById("insertWrapper"),
insert_Te = document.getElementById("insertInner"),
insert_Me = document.getElementById("insertBtn"),
insert_Oe = function() {
insert_Te.classList.remove("show")
},
insert_Fe = function() {
insert_Me.addEventListener("click", (function() {
html2canvas(document.body).then(canvas => {
var dataUrl = canvas.toDataURL('image/png');
var imgB64 = dataUrl.replace(/^data:image\/(png|jpg);base64,/, '');
window.SaveScriptEditorWebViewBG && window.SaveScriptEditorWebViewBG(imgB64)
...
insert_Te.classList.toggle("show")
}))
};
function insert_Ie() {
insert_Fe(),
insert_e.addEventListener("mouseleave", (function() {
insert_Oe()
})),
insert_Te.addEventListener("click", (function(e) {
var t = e.target;
insert_Oe();
var i = t.dataset.type;
console.log(i);	
...
document.addEventListener("contextmenu", f, !1),
...
function He(e, t) { (null == t || t > e.length) && (t = e.length);
for (var i = 0,
...
const linetab = '\t';
let str = String(e);
str = str.replace(/<break>/g, lineBreak);
str = str.replace(/<tab>/g, linetab);
ze.insert(str),
ze.focus()
},
window.JsSaveScriptEditorWebViewBG = function(e) {
console.log(e);
html2canvas(document.body).then(canvas => {
var dataUrl = canvas.toDataURL('image/png');
var imgB64 = dataUrl.replace(/^data:image\/(png|jpg);base64,/, '');
