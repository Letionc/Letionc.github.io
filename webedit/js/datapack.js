...
snippet coroutine.running 看在运行的线程\n\
	coroutine.running()${1:}\n\
snippet EventDispatch事件分发\n\
	Game:dispatchEvent('${1:EventName}',{customdata = ${2:eventJson}})\n\
snippet functionLocal局部函数\n\
...
snippet ScriptSupportEvent:registerEvent(v1)\n\
	ScriptSupportEvent:registerEvent('${1:event}',${2:func})\n\
snippet 绘制长方体(v1)\n\
	--设置起点坐标\n\
	local mapx = 0 \n\
	local mapy = 7 \n\
...
function GetServiceFuncs() {
	var jsonObj = [
		...
		{"name":"WorldContainer.setStorageItem", "caption":"WorldContainer:setStorageItem", "value":"WorldContainer:setStorageItem(x, y, z, offset, itemid, num)", "meta":"WorldContainer", "type":"local", "score":9},
		{"name":"threadpool.wait","caption":"threadpool:wait","value":"threadpool:wait(sec)","meta":"(Custom)","type":"local","score":9},
		{"name":"Player.openUIView", "caption":"Player:openUIView", "value":"Player:openUIView(uin,uiid)", "meta":"Customui", "type":"local", "score":9},
		{"name":"Player.hideUIView", "caption":"Player:hideUIView", "value":"Player:hideUIView(uin,uiid)", "meta":"Customui", "type":"local", "score":9},
...
{"name":"Customui.setTexture","caption":"Customui:setTexture","value":"Customui:setTexture(playerid, uiid, elementid, pngid)","meta":"Customui","type":"local","score":9},
...
{"name":"Customui.setColor","caption":"Customui:setColor","value":"Customui:setColor(playerid, uiid, elementid, color0xhex)","meta":"Customui","type":"local","score":9},
...
{"name":"Customui.getItemIcon","caption":"Customui:getItemIcon","value":"Customui:getItemIcon(itemid)","meta":"Customui","type":"local","score":9},
{"name":"Customui.getMonsterObjIcon","caption":"Customui:getMonsterObjIcon","value":"Customui:getMonsterObjIcon(actorid)","meta":"Customui","type":"local","score":9},
{"name":"Customui.getMonsterIcon","caption":"Customui:getMonsterIcon","value":"Customui:getMonsterIcon(actorTypeid)","meta":"Customui","type":"local","score":9},
{"name":"Customui.getStatusIcon","caption":"Customui:getStatusIcon","value":"Customui:getStatusIcon(buffid)","meta":"Customui","type":"local","score":9},
{"name":"Customui.getBlockIcon","caption":"Customui:getBlockIcon","value":"Customui:getBlockIcon(blockid)","meta":"Customui","type":"local","score":9},
{"name":"Customui.getRoleIcon","caption":"Customui:getRoleIcon","value":"Customui:getRoleIcon(playerid)","meta":"Customui","type":"local","score":9},
{"name":"Customui.getShuctIcon","caption":"Customui:getShuctIcon","value":"Customui:getShuctIcon(playerid, backpackIndex)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SmoothMoveTo","caption":"Customui:SmoothMoveTo","value":"Customui:SmoothMoveTo(playerid, uiid, elementid, time, x, y)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SmoothMoveBy","caption":"Customui:SmoothMoveBy","value":"Customui:SmoothMoveBy(playerid, uiid, elementid, time, addx, addy)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SmoothScaleTo","caption":"Customui:SmoothScaleTo","value":"Customui:SmoothScaleTo(playerid, uiid, elementid, time, w, h)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SmoothScaleBy","caption":"Customui:SmoothScaleBy","value":"Customui:SmoothScaleBy(playerid, uiid, elementid, time, addw, addh)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SmoothRotateTo","caption":"Customui:SmoothRotateTo","value":"Customui:SmoothRotateTo(playerid, uiid, elementid, time, angle)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SmoothRotateBy","caption":"Customui:SmoothRotateBy","value":"Customui:SmoothRotateBy(playerid, uiid, elementid, time, addangle)","meta":"Customui","type":"local","score":9},
{"name":"Customui.PlayElementAnim","caption":"Customui:PlayElementAnim","value":"Customui:PlayElementAnim(playerid, uiid, elementid, actionid, time, playmode)","meta":"Customui","type":"local","score":9},
{"name":"Customui.StopAnim","caption":"Customui:StopAnim","value":"Customui:StopAnim(playerid, uiid, elementid)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SetLoaderModel","caption":"Customui:SetLoaderModel","value":"Customui:SetLoaderModel(playerid, uiid, elementid, modelid)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SetLoaderModelScale","caption":"Customui:SetLoaderModelScale","value":"Customui:SetLoaderModelScale(playerid, uiid, elementid, modelsize)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SetLoaderModelDir","caption":"Customui:SetLoaderModelDir","value":"Customui:SetLoaderModelDir(playerid, uiid, elementid, LRyaw)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SetLoaderModelAct","caption":"Customui:SetLoaderModelAct","value":"Customui:SetLoaderModelAct(playerid, uiid, elementid, actionid, playmode)","meta":"Customui","type":"local","score":9},
{"name":"Customui.TurnSliderToPos","caption":"Customui:TurnSliderToPos","value":"Customui:TurnSliderToPos(playerid, uiid, elementid, xIn, yIn)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SetSliderDir","caption":"Customui:SetSliderDir","value":"Customui:SetSliderDir(playerid, uiid, elementid, way)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SetSliderBarImg","caption":"Customui:SetSliderBarImg","value":"Customui:SetSliderBarImg(playerid, uiid, elementid, pngid)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SetProgressBarValue","caption":"Customui:SetProgressBarValue","value":"Customui:SetProgressBarValue(playerid, uiid, elementid, numtype, value)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SetProgressBarResId","caption":"Customui:SetProgressBarResId","value":"Customui:SetProgressBarResId(playerid, uiid, elementid, changeobject, pngid)","meta":"Customui","type":"local","score":9},
{"name":"Customui.SmoothIncreaseProgress","caption":"Customui:SmoothIncreaseProgress","value":"Customui:SmoothIncreaseProgress(playerid, uiid, elementid, time, changetype, value)","meta":"Customui","type":"local","score":9},
	]
	return jsonObj
}
...
{"name":"Event$Backpack.ItemChange","caption":"容器内道具变化$Backpack.ItemChange","value":"ScriptSupportEvent:registerEvent([=[Backpack.ItemChange]=],fun)-- 容器内道具变化  blockid,itemid,itemnum,x,y,z","meta":"blockid,itemid,itemnum,x,y,z","type":"local","score":6},
{"name":"Event$Backpack.ItemPutIn","caption":"容器内有道具放入$Backpack.ItemPutIn","value":"ScriptSupportEvent:registerEvent([=[Backpack.ItemPutIn]=],fun)-- 容器内有道具放入  blockid,itemid,itemnum,x,y,z","meta":"blockid,itemid,itemnum,x,y,z","type":"local","score":6},
{"name":"Event$Backpack.ItemTakeOut","caption":"容器内有道具取出$Backpack.ItemTakeOut","value":"ScriptSupportEvent:registerEvent([=[Backpack.ItemTakeOut]=],fun)-- 容器内有道具取出  blockid,itemid,itemnum,x,y,z","meta":"blockid,itemid,itemnum,x,y,z","type":"local","score":6},
{"name":"Event$Game.Hour","caption":"世界小时时间变化$Game.Hour","value":"ScriptSupportEvent:registerEvent([=[Game.Hour]=],fun)-- 世界小时时间变化  hour","meta":"hour","type":"local","score":6},
{"name":"Event$Game.RunTime","caption":"世界Tick变化$Game.RunTime","value":"ScriptSupportEvent:registerEvent([=[Game.RunTime]=],fun)-- 世界Tick变化  second,ticks","meta":"second,ticks","type":"local","score":6},
{"name":"Event$Game.AnyPlayer.Defeat","caption":"任一玩家失败$Game.AnyPlayer.Defeat","value":"ScriptSupportEvent:registerEvent([=[Game.AnyPlayer.Defeat]=],fun)-- 任一玩家失败  eventobjid,shortix,x,y,z","meta":"eventobjid,shortix,x,y,z","type":"local","score":6},
{"name":"Event$Game.AnyPlayer.EnterGame","caption":"任一玩家进入$Game.AnyPlayer.EnterGame","value":"ScriptSupportEvent:registerEvent([=[Game.AnyPlayer.EnterGame]=],fun)-- 任一玩家进入  eventobjid,shortix,x,y,z","meta":"eventobjid,shortix,x,y,z","type":"local","score":6},
{"name":"Event$Game.AnyPlayer.LeaveGame","caption":"任一玩家离开$Game.AnyPlayer.LeaveGame","value":"ScriptSupportEvent:registerEvent([=[Game.AnyPlayer.LeaveGame]=],fun)-- 任一玩家离开  eventobjid,shortix,x,y,z","meta":"eventobjid,shortix,x,y,z","type":"local","score":6},
{"name":"Event$Game.AnyPlayer.Victory","caption":"任一玩家胜利$Game.AnyPlayer.Victory","value":"ScriptSupportEvent:registerEvent([=[Game.AnyPlayer.Victory]=],fun)-- 任一玩家胜利  eventobjid,shortix,x,y,z","meta":"eventobjid,shortix,x,y,z","type":"local","score":6},
{"name":"Event$Player.AddBuff","caption":"玩家获得状态效果$Player.AddBuff","value":"ScriptSupportEvent:registerEvent([=[Player.AddBuff]=],fun)-- 玩家获得状态效果  eventobjid,buffid,bufflvl","meta":"eventobjid,buffid,bufflvl","type":"local","score":6},
{"name":"Event$Player.AddItem","caption":"玩家获得道具$Player.AddItem","value":"ScriptSupportEvent:registerEvent([=[Player.AddItem]=],fun)-- 玩家获得道具  eventobjid,itemid,itemnum","meta":"eventobjid,itemid,itemnum","type":"local","score":6},
{"name":"Event$Player.AreaIn","caption":"玩家进入区域$Player.AreaIn","value":"ScriptSupportEvent:registerEvent([=[Player.AreaIn]=],fun)-- 玩家进入区域  eventobjid,areaid","meta":"eventobjid,areaid","type":"local","score":6},
{"name":"Event$Player.AreaOut","caption":"玩家离开区域$Player.AreaOut","value":"ScriptSupportEvent:registerEvent([=[Player.AreaOut]=],fun)-- 玩家离开区域  eventobjid,areaid","meta":"eventobjid,areaid","type":"local","score":6},
{"name":"Event$Player.AttackHit","caption":"玩家击中目标$Player.AttackHit","value":"ScriptSupportEvent:registerEvent([=[Player.AttackHit]=],fun)-- 玩家击中目标  eventobjid,targetactorid","meta":"eventobjid,targetactorid","type":"local","score":6},
{"name":"Event$Player.Attack","caption":"玩家攻击$Player.Attack","value":"ScriptSupportEvent:registerEvent([=[Player.Attack]=],fun)-- 玩家攻击  eventobjid,shortix,x,y,z","meta":"eventobjid,shortix,x,y,z","type":"local","score":6},
{"name":"Event$Player.BackPackChange","caption":"背包栏变化$Player.BackPackChange","value":"ScriptSupportEvent:registerEvent([=[Player.BackPackChange]=],fun)-- 背包栏变化  ","meta":"","type":"local","score":6},
{"name":"Event$Player.BeHurt","caption":"玩家受到伤害$Player.BeHurt","value":"ScriptSupportEvent:registerEvent([=[Player.BeHurt]=],fun)-- 玩家受到伤害  eventobjid,hurtlv","meta":"eventobjid,hurtlv","type":"local","score":6},
{"name":"Event$Player.ChangeAttr","caption":"玩家属性变化$Player.ChangeAttr","value":"ScriptSupportEvent:registerEvent([=[Player.ChangeAttr]=],fun)-- 玩家属性变化  eventobjid,shortix,playerattr,playerattrval,x,y,z","meta":"eventobjid,shortix,playerattr,playerattrval,x,y,z","type":"local","score":6},
{"name":"Event$Player.ClickActor","caption":"点击生物$Player.ClickActor","value":"ScriptSupportEvent:registerEvent([=[Player.ClickActor]=],fun)-- 点击生物  eventobjid,targetactorid","meta":"eventobjid,targetactorid","type":"local","score":6},
{"name":"Event$Player.ClickBlock","caption":"点击方块$Player.ClickBlock","value":"ScriptSupportEvent:registerEvent([=[Player.ClickBlock]=],fun)-- 点击方块  eventobjid,blockid,x,y,z","meta":"eventobjid,blockid,x,y,z","type":"local","score":6},
{"name":"Event$Player.Collide","caption":"玩家跟玩家/生物碰撞$Player.Collide","value":"ScriptSupportEvent:registerEvent([=[Player.Collide]=],fun)-- 玩家跟玩家/生物碰撞  eventobjid,toobjid","meta":"eventobjid,toobjid","type":"local","score":6},
{"name":"Event$Player.ConsumeItem","caption":"玩家消耗道具$Player.ConsumeItem","value":"ScriptSupportEvent:registerEvent([=[Player.ConsumeItem]=],fun)-- 玩家消耗道具  eventobjid,itemid,itemnum","meta":"eventobjid,itemid,itemnum","type":"local","score":6},
{"name":"Event$Player.DamageActor","caption":"玩家造成伤害$Player.DamageActor","value":"ScriptSupportEvent:registerEvent([=[Player.DamageActor]=],fun)-- 玩家造成伤害  eventobjid,toobjid,targetactorid,hurtlv","meta":"eventobjid,toobjid,targetactorid,hurtlv","type":"local","score":6},
{"name":"Event$Player.DefeatActor","caption":"玩家击败目标$Player.DefeatActor","value":"ScriptSupportEvent:registerEvent([=[Player.DefeatActor]=],fun)-- 玩家击败目标  eventobjid,toobjid,targetactorid","meta":"eventobjid,toobjid,targetactorid","type":"local","score":6},
{"name":"Event$Player.Die","caption":"玩家死亡$Player.Die","value":"ScriptSupportEvent:registerEvent([=[Player.Die]=],fun)-- 玩家死亡  eventobjid,shortix,x,y,z","meta":"eventobjid,shortix,x,y,z","type":"local","score":6},
{"name":"Event$Player.DiscardItem","caption":"丢弃道具$Player.DiscardItem","value":"ScriptSupportEvent:registerEvent([=[Player.DiscardItem]=],fun)-- 丢弃道具  eventobjid,itemid,itemnum,toobjid","meta":"eventobjid,itemid,itemnum,toobjid","type":"local","score":6},
{"name":"Event$Player.DismountActor","caption":"玩家骑乘下$Player.DismountActor","value":"ScriptSupportEvent:registerEvent([=[Player.DismountActor]=],fun)-- 玩家骑乘下  eventobjid,targetactorid","meta":"eventobjid,targetactorid","type":"local","score":6},
{"name":"Event$Player.EquipChange","caption":"装备栏变化$Player.EquipChange","value":"ScriptSupportEvent:registerEvent([=[Player.EquipChange]=],fun)-- 装备栏变化  eventobjid,itemid,itemnum,itemix","meta":"eventobjid,itemid,itemnum,itemix","type":"local","score":6},
{"name":"Event$Player.EquipOff","caption":"脱下装备$Player.EquipOff","value":"ScriptSupportEvent:registerEvent([=[Player.EquipOff]=],fun)-- 脱下装备  eventobjid,itemid,itemnum,itemix","meta":"eventobjid,itemid,itemnum,itemix","type":"local","score":6},
{"name":"Event$Player.EquipOn","caption":"穿上装备$Player.EquipOn","value":"ScriptSupportEvent:registerEvent([=[Player.EquipOn]=],fun)-- 穿上装备  eventobjid,itemid,itemnum,itemix","meta":"eventobjid,itemid,itemnum,itemix","type":"local","score":6},
{"name":"Event$Player.InputContent","caption":"输入字符串$Player.InputContent","value":"ScriptSupportEvent:registerEvent([=[Player.InputContent]=],fun)-- 输入字符串  eventobjid,content","meta":"eventobjid,content","type":"local","score":6},
{"name":"Event$Player.InputKeyDown","caption":"玩家按下按键$Player.InputKeyDown","value":"ScriptSupportEvent:registerEvent([=[Player.InputKeyDown]=],fun)-- 玩家按下按键  eventobjid,vkey","meta":"eventobjid,vkey","type":"local","score":6},
{"name":"Event$Player.InputKeyOnPress","caption":"玩家长按按键$Player.InputKeyOnPress","value":"ScriptSupportEvent:registerEvent([=[Player.InputKeyOnPress]=],fun)-- 玩家长按按键  eventobjid,vkey","meta":"eventobjid,vkey","type":"local","score":6},
{"name":"Event$Player.InputKeyUp","caption":"玩家松开按键$Player.InputKeyUp","value":"ScriptSupportEvent:registerEvent([=[Player.InputKeyUp]=],fun)-- 玩家松开按键  eventobjid,vkey","meta":"eventobjid,vkey","type":"local","score":6},
{"name":"Event$Player.InvateFriend","caption":"邀请好友 $Player.InvateFriend","value":"ScriptSupportEvent:registerEvent([=[Player.InvateFriend]=],fun)-- 邀请好友   eventobjid,toobjid","meta":"eventobjid,toobjid","type":"local","score":6},
{"name":"Event$Player.LevelModelUpgrade","caption":"玩家等级发生改变$Player.LevelModelUpgrade","value":"ScriptSupportEvent:registerEvent([=[Player.LevelModelUpgrade]=],fun)-- 玩家等级发生改变  eventobjid","meta":"eventobjid","type":"local","score":6},
{"name":"Event$Player.MotionStateChange","caption":"玩家行为状态变更$Player.MotionStateChange","value":"ScriptSupportEvent:registerEvent([=[Player.MotionStateChange]=],fun)-- 玩家行为状态变更  eventobjid,playermotion","meta":"eventobjid,playermotion","type":"local","score":6},
{"name":"Event$Player.MountActor","caption":"玩家骑乘上$Player.MountActor","value":"ScriptSupportEvent:registerEvent([=[Player.MountActor]=],fun)-- 玩家骑乘上  eventobjid,targetactorid","meta":"eventobjid,targetactorid","type":"local","score":6},
{"name":"Event$Player.MoveOneBlockSize","caption":"玩家移动(移动一格)$Player.MoveOneBlockSize","value":"ScriptSupportEvent:registerEvent([=[Player.MoveOneBlockSize]=],fun)-- 玩家移动(移动一格)  eventobjid,shortix,x,y,z","meta":"eventobjid,shortix,x,y,z","type":"local","score":6},
{"name":"Event$Player.NewInputContent","caption":"从聊天框输入$Player.NewInputContent","value":"ScriptSupportEvent:registerEvent([=[Player.NewInputContent]=],fun)-- 从聊天框输入  eventobjid,content","meta":"eventobjid,content","type":"local","score":6},
{"name":"Event$Player.PickUpItem","caption":"玩家拾取$Player.PickUpItem","value":"ScriptSupportEvent:registerEvent([=[Player.PickUpItem]=],fun)-- 玩家拾取  eventobjid,toobjid,itemid,itemnum","meta":"eventobjid,toobjid,itemid,itemnum","type":"local","score":6},
{"name":"Event$Player.PlayAction","caption":"玩家使用表情动作$Player.PlayAction","value":"ScriptSupportEvent:registerEvent([=[Player.PlayAction]=],fun)-- 玩家使用表情动作  eventobjid,act","meta":"eventobjid,act","type":"local","score":6},
{"name":"Event$Player.RemoveBuff","caption":"玩家失去指定状态效果$Player.RemoveBuff","value":"ScriptSupportEvent:registerEvent([=[Player.RemoveBuff]=],fun)-- 玩家失去指定状态效果  eventobjid,buffid,bufflvl","meta":"eventobjid,buffid,bufflvl","type":"local","score":6},
{"name":"Event$Player.Revive","caption":"玩家复活$Player.Revive","value":"ScriptSupportEvent:registerEvent([=[Player.Revive]=],fun)-- 玩家复活  eventobjid,shortix,x,y,z","meta":"eventobjid,shortix,x,y,z","type":"local","score":6},
{"name":"Event$Player.SelectShortcut","caption":"快捷栏选择$Player.SelectShortcut","value":"ScriptSupportEvent:registerEvent([=[Player.SelectShortcut]=],fun)-- 快捷栏选择  eventobjid,itemid,itemnum","meta":"eventobjid,itemid,itemnum","type":"local","score":6},
{"name":"Event$Player.ShortcutChange","caption":"快捷栏变化$Player.ShortcutChange","value":"ScriptSupportEvent:registerEvent([=[Player.ShortcutChange]=],fun)-- 快捷栏变化  eventobjid,itemid,itemnum,itemix","meta":"eventobjid,itemid,itemnum,itemix","type":"local","score":6},
{"name":"Event$Player.UseGiftPack","caption":"局部此类包裹道具被使用[]$Player.UseGiftPack","value":"ScriptSupportEvent:registerEvent([=[Player.UseGiftPack]=],fun)-- 局部此类包裹道具被使用[]  eventobjid,itemid,itemnum","meta":"eventobjid,itemid,itemnum","type":"local","score":6},
{"name":"Event$Player.UseItem","caption":"玩家使用道具$Player.UseItem","value":"ScriptSupportEvent:registerEvent([=[Player.UseItem]=],fun)-- 玩家使用道具  eventobjid,itemid,itemnum,itemix","meta":"eventobjid,itemid,itemnum,itemix","type":"local","score":6},
{"name":"Event$Actor.AddBuff","caption":"生物获得状态效果$Actor.AddBuff","value":"ScriptSupportEvent:registerEvent([=[Actor.AddBuff]=],fun)-- 生物获得状态效果  eventobjid,actorid,buffid,bufflvl","meta":"eventobjid,actorid,buffid,bufflvl","type":"local","score":6},
{"name":"Event$Actor.AreaIn","caption":"生物进入区域$Actor.AreaIn","value":"ScriptSupportEvent:registerEvent([=[Actor.AreaIn]=],fun)-- 生物进入区域  eventobjid,areaid","meta":"eventobjid,areaid","type":"local","score":6},
{"name":"Event$Actor.AreaOut","caption":"生物离开区域$Actor.AreaOut","value":"ScriptSupportEvent:registerEvent([=[Actor.AreaOut]=],fun)-- 生物离开区域  eventobjid,areaid","meta":"eventobjid,areaid","type":"local","score":6},
{"name":"Event$Actor.AttackHit","caption":"攻击命中$Actor.AttackHit","value":"ScriptSupportEvent:registerEvent([=[Actor.AttackHit]=],fun)-- 攻击命中  eventobjid,toobjid,actorid,targetactorid","meta":"eventobjid,toobjid,actorid,targetactorid","type":"local","score":6},
{"name":"Event$Actor.Attack","caption":"攻击$Actor.Attack","value":"ScriptSupportEvent:registerEvent([=[Actor.Attack]=],fun)-- 攻击  eventobjid,toobjid,actorid,targetactorid","meta":"eventobjid,toobjid,actorid,targetactorid","type":"local","score":6},
{"name":"Event$Actor.BeHurt","caption":"受到伤害$Actor.BeHurt","value":"ScriptSupportEvent:registerEvent([=[Actor.BeHurt]=],fun)-- 受到伤害  eventobjid,toobjid,hurtlv,actorid","meta":"eventobjid,toobjid,hurtlv,actorid","type":"local","score":6},
{"name":"Event$Actor.Beat","caption":"生物击败玩家/生物$Actor.Beat","value":"ScriptSupportEvent:registerEvent([=[Actor.Beat]=],fun)-- 生物击败玩家/生物  eventobjid,toobjid,actorid,targetactorid","meta":"eventobjid,toobjid,actorid,targetactorid","type":"local","score":6},
{"name":"Event$Actor.ChangeAttr","caption":"属性变化$Actor.ChangeAttr","value":"ScriptSupportEvent:registerEvent([=[Actor.ChangeAttr]=],fun)-- 属性变化  eventobjid,actorid,actorattr,actorattrval","meta":"eventobjid,actorid,actorattr,actorattrval","type":"local","score":6},
{"name":"Event$Actor.ChangeMotion","caption":"生物行为状态变更到[n]$Actor.ChangeMotion","value":"ScriptSupportEvent:registerEvent([=[Actor.ChangeMotion]=],fun)-- 生物行为状态变更到[n]  eventobjid,actorid,actormotion","meta":"eventobjid,actorid,actormotion","type":"local","score":6},
{"name":"Event$Actor.Collide","caption":"碰撞到玩家/生物$Actor.Collide","value":"ScriptSupportEvent:registerEvent([=[Actor.Collide]=],fun)-- 碰撞到玩家/生物  eventobjid,toobjid,actorid,targetactorid","meta":"eventobjid,toobjid,actorid,targetactorid","type":"local","score":6},
{"name":"Event$Actor.Create","caption":"被创建$Actor.Create","value":"ScriptSupportEvent:registerEvent([=[Actor.Create]=],fun)-- 被创建  eventobjid,actorid","meta":"eventobjid,actorid","type":"local","score":6},
{"name":"Event$Actor.Damage","caption":"造成伤害$Actor.Damage","value":"ScriptSupportEvent:registerEvent([=[Actor.Damage]=],fun)-- 造成伤害  eventobjid,toobjid,hurtlv,actorid,targetactorid","meta":"eventobjid,toobjid,hurtlv,actorid,targetactorid","type":"local","score":6},
{"name":"Event$Actor.Die","caption":"死亡$Actor.Die","value":"ScriptSupportEvent:registerEvent([=[Actor.Die]=],fun)-- 死亡  eventobjid,toobjid,actorid","meta":"eventobjid,toobjid,actorid","type":"local","score":6},
{"name":"Event$Actor.Projectile.Hit","caption":"投掷物击中$Actor.Projectile.Hit","value":"ScriptSupportEvent:registerEvent([=[Actor.Projectile.Hit]=],fun)-- 投掷物击中  eventobjid,toobjid,itemid,targetactorid,x,y,z,helperobjid","meta":"eventobjid,toobjid,itemid,targetactorid,x,y,z,helperobjid","type":"local","score":6},
{"name":"Event$Actor.RemoveBuff","caption":"生物失去状态效果$Actor.RemoveBuff","value":"ScriptSupportEvent:registerEvent([=[Actor.RemoveBuff]=],fun)-- 生物失去状态效果  eventobjid,actorid,buffid,bufflvl","meta":"eventobjid,actorid,buffid,bufflvl","type":"local","score":6},
{"name":"Event$Block.Add","caption":"被创建$Block.Add","value":"ScriptSupportEvent:registerEvent([=[Block.Add]=],fun)-- 被创建  blockid,x,y,z","meta":"blockid,x,y,z","type":"local","score":6},
{"name":"Event$Block.DestroyBy","caption":"局部此类方块被破坏时$Block.DestroyBy","value":"ScriptSupportEvent:registerEvent([=[Block.DestroyBy]=],fun)-- 局部此类方块被破坏时  eventobjid,blockid,x,y,z","meta":"eventobjid,blockid,x,y,z","type":"local","score":6},
{"name":"Event$Block.Dig.Begin","caption":"任意方块被挖掘时$Block.Dig.Begin","value":"ScriptSupportEvent:registerEvent([=[Block.Dig.Begin]=],fun)-- 任意方块被挖掘时  eventobjid,blockid,x,y,z","meta":"eventobjid,blockid,x,y,z","type":"local","score":6},
{"name":"Event$Block.Dig.Cancel","caption":"任意方块被挖掘取消$Block.Dig.Cancel","value":"ScriptSupportEvent:registerEvent([=[Block.Dig.Cancel]=],fun)-- 任意方块被挖掘取消  eventobjid,blockid,x,y,z","meta":"eventobjid,blockid,x,y,z","type":"local","score":6},
{"name":"Event$Block.Dig.End","caption":"方块被挖$Block.Dig.End","value":"ScriptSupportEvent:registerEvent([=[Block.Dig.End]=],fun)-- 方块被挖  eventobjid,blockid,x,y,z","meta":"eventobjid,blockid,x,y,z","type":"local","score":6},
{"name":"Event$Block.Remove","caption":"方块移除$Block.Remove","value":"ScriptSupportEvent:registerEvent([=[Block.Remove]=],fun)-- 方块移除  blockid,x,y,z","meta":"blockid,x,y,z","type":"local","score":6},
{"name":"Event$Block.Trigger","caption":"活跃/通电$Block.Trigger","value":"ScriptSupportEvent:registerEvent([=[Block.Trigger]=],fun)-- 活跃/通电  eventobjid,blockid,x,y,z","meta":"eventobjid,blockid,x,y,z","type":"local","score":6},
{"name":"Event$DropItem.AreaIn","caption":"掉落物进入区域$DropItem.AreaIn","value":"ScriptSupportEvent:registerEvent([=[DropItem.AreaIn]=],fun)-- 掉落物进入区域  eventobjid,areaid,itemid","meta":"eventobjid,areaid,itemid","type":"local","score":6},
{"name":"Event$DropItem.AreaOut","caption":"掉落物离开区域$DropItem.AreaOut","value":"ScriptSupportEvent:registerEvent([=[DropItem.AreaOut]=],fun)-- 掉落物离开区域  eventobjid,areaid,itemid","meta":"eventobjid,areaid,itemid","type":"local","score":6},
{"name":"Event$Item.Create","caption":"掉落物被创建$Item.Create","value":"ScriptSupportEvent:registerEvent([=[Item.Create]=],fun)-- 掉落物被创建  eventobjid,itemid,defaultvalue,x,y,z","meta":"eventobjid,itemid,defaultvalue,x,y,z","type":"local","score":6},
{"name":"Event$Item.Destroy","caption":"局部此类装备被破坏时$Item.Destroy","value":"ScriptSupportEvent:registerEvent([=[Item.Destroy]=],fun)-- 局部此类装备被破坏时  eventobjid,itemid,itemnum","meta":"eventobjid,itemid,itemnum","type":"local","score":6},
{"name":"Event$Item.Disappear","caption":"掉落物消失$Item.Disappear","value":"ScriptSupportEvent:registerEvent([=[Item.Disappear]=],fun)-- 掉落物消失  eventobjid,itemid,itemnum,x,y,z","meta":"eventobjid,itemid,itemnum,x,y,z","type":"local","score":6},
{"name":"Event$Item.Pickup","caption":"掉落物被拾取$Item.Pickup","value":"ScriptSupportEvent:registerEvent([=[Item.Pickup]=],fun)-- 掉落物被拾取  eventobjid,toobjid,itemid,itemnum,x,y,z","meta":"eventobjid,toobjid,itemid,itemnum,x,y,z","type":"local","score":6},
{"name":"Event$Item.expend","caption":"局部此类食物道具被消耗$Item.expend","value":"ScriptSupportEvent:registerEvent([=[Item.expend]=],fun)-- 局部此类食物道具被消耗  eventobjid,itemid,itemnum","meta":"eventobjid,itemid,itemnum","type":"local","score":6},
{"name":"Event$Missile.AreaIn","caption":"投掷物进入区域$Missile.AreaIn","value":"ScriptSupportEvent:registerEvent([=[Missile.AreaIn]=],fun)-- 投掷物进入区域  eventobjid,areaid,itemid,helperobjid","meta":"eventobjid,areaid,itemid,helperobjid","type":"local","score":6},
{"name":"Event$Missile.AreaOut","caption":"投掷物离开区域$Missile.AreaOut","value":"ScriptSupportEvent:registerEvent([=[Missile.AreaOut]=],fun)-- 投掷物离开区域  eventobjid,areaid,itemid,helperobjid","meta":"eventobjid,areaid,itemid,helperobjid","type":"local","score":6},
{"name":"Event$Missile.Create","caption":"投掷物被创建$Missile.Create","value":"ScriptSupportEvent:registerEvent([=[Missile.Create]=],fun)-- 投掷物被创建  eventobjid,itemid,toobjid,x,y,z","meta":"eventobjid,itemid,toobjid,x,y,z","type":"local","score":6},
{"name":"Event$Particle.Mob.OnCreate","caption":"任意生物身上特效被创建$Particle.Mob.OnCreate","value":"ScriptSupportEvent:registerEvent([=[Particle.Mob.OnCreate]=],fun)-- 任意生物身上特效被创建  eventobjid,effectid,x,y,z","meta":"eventobjid,effectid,x,y,z","type":"local","score":6},
{"name":"Event$Particle.Player.OnCreate","caption":"任意玩家身上特效被创建$Particle.Player.OnCreate","value":"ScriptSupportEvent:registerEvent([=[Particle.Player.OnCreate]=],fun)-- 任意玩家身上特效被创建  eventobjid,effectid,x,y,z","meta":"eventobjid,effectid,x,y,z","type":"local","score":6},
{"name":"Event$Particle.Pos.OnCreate","caption":"任意位置上特效被创建$Particle.Pos.OnCreate","value":"ScriptSupportEvent:registerEvent([=[Particle.Pos.OnCreate]=],fun)-- 任意位置上特效被创建  effectid,x,y,z","meta":"effectid,x,y,z","type":"local","score":6},
{"name":"Event$Particle.Projectile.OnCreate","caption":"任意投掷物特效被创建$Particle.Projectile.OnCreate","value":"ScriptSupportEvent:registerEvent([=[Particle.Projectile.OnCreate]=],fun)-- 任意投掷物特效被创建  eventobjid,effectid,x,y,z","meta":"eventobjid,effectid,x,y,z","type":"local","score":6},
{"name":"Event$Particle.Item.OnCreate","caption":"当特效在掉落物上创建$Particle.Item.OnCreate","value":"ScriptSupportEvent:registerEvent([=[Particle.Item.OnCreate]=],fun)-- 当特效在掉落物上创建  eventobjid,effectid,x,y,z","meta":"eventobjid,effectid,x,y,z","type":"local","score":6},
{"name":"Event$UI.Button.Click","caption":"按钮点击$UI.Button.Click","value":"ScriptSupportEvent:registerEvent([=[UI.Button.Click]=],fun)-- 按钮点击  eventobjid,CustomUI,uielement","meta":"eventobjid,CustomUI,uielement","type":"local","score":6},
{"name":"Event$UI.Button.TouchBegin","caption":"按钮按下$UI.Button.TouchBegin","value":"ScriptSupportEvent:registerEvent([=[UI.Button.TouchBegin]=],fun)-- 按钮按下  eventobjid,CustomUI,uielement","meta":"eventobjid,CustomUI,uielement","type":"local","score":6},
{"name":"Event$UI.GLoader3D.Click","caption":"当前界面的模型被松开$UI.GLoader3D.Click","value":"ScriptSupportEvent:registerEvent([=[UI.GLoader3D.Click]=],fun)-- 当前界面的模型被松开  eventobjid,CustomUI,uielement","meta":"eventobjid,CustomUI,uielement","type":"local","score":6},
{"name":"Event$UI.GLoader3D.TouchBegin","caption":"当前界面的模型被按下$UI.GLoader3D.TouchBegin","value":"ScriptSupportEvent:registerEvent([=[UI.GLoader3D.TouchBegin]=],fun)-- 当前界面的模型被按下  eventobjid,CustomUI,uielement","meta":"eventobjid,CustomUI,uielement","type":"local","score":6},
{"name":"Event$UI.Hide","caption":"界面被关闭$UI.Hide","value":"ScriptSupportEvent:registerEvent([=[UI.Hide]=],fun)-- 界面被关闭  eventobjid,CustomUI","meta":"eventobjid,CustomUI","type":"local","score":6},
{"name":"Event$UI.LostFocus","caption":"自定义ui输入框失去焦点$UI.LostFocus","value":"ScriptSupportEvent:registerEvent([=[UI.LostFocus]=],fun)-- 自定义ui输入框失去焦点  eventobjid,CustomUI,uielement,content","meta":"eventobjid,CustomUI,uielement,content","type":"local","score":6},
{"name":"Event$UI.Show","caption":"界面被打开$UI.Show","value":"ScriptSupportEvent:registerEvent([=[UI.Show]=],fun)-- 界面被打开  eventobjid,CustomUI","meta":"eventobjid,CustomUI","type":"local","score":6},
{"name":"Event$BluePrint.BuildBegin","caption":"蓝图开始创建$BluePrint.BuildBegin","value":"ScriptSupportEvent:registerEvent([=[BluePrint.BuildBegin]=],fun)-- 蓝图开始创建  areaid","meta":"areaid","type":"local","score":6},
{"name":"Event$Craft.end","caption":"任意配方合成完成$Craft.end","value":"ScriptSupportEvent:registerEvent([=[Craft.end]=],fun)-- 任意配方合成完成  eventobjid,craftid,itemid,itemnum","meta":"eventobjid,craftid,itemid,itemnum","type":"local","score":6},
{"name":"Event$Developer.BuyItem","caption":"任意玩家购买或提取商品道具$Developer.BuyItem","value":"ScriptSupportEvent:registerEvent([=[Developer.BuyItem]=],fun)-- 任意玩家购买或提取商品道具  eventobjid,itemid","meta":"eventobjid,itemid","type":"local","score":6},
{"name":"Event$Furnace.begin","caption":"任意熔炼开始$Furnace.begin","value":"ScriptSupportEvent:registerEvent([=[Furnace.begin]=],fun)-- 任意熔炼开始  furanceid,x,y,z","meta":"furanceid,x,y,z","type":"local","score":6},
{"name":"Event$Furnace.end","caption":"任意熔炼结束$Furnace.end","value":"ScriptSupportEvent:registerEvent([=[Furnace.end]=],fun)-- 任意熔炼结束  furanceid,x,y,z","meta":"furanceid,x,y,z","type":"local","score":6},
{"name":"Event$MiNiVip_1","caption":"购买迷你大会员1个月$MiNiVip_1","value":"ScriptSupportEvent:registerEvent([=[MiNiVip_1]=],fun)-- 购买迷你大会员1个月  eventobjid","meta":"eventobjid","type":"local","score":6},
{"name":"Event$MiNiVip_3","caption":"购买迷你大会员3个月$MiNiVip_3","value":"ScriptSupportEvent:registerEvent([=[MiNiVip_3]=],fun)-- 购买迷你大会员3个月  eventobjid","meta":"eventobjid","type":"local","score":6},
{"name":"Event$Plot.begin","caption":"任意剧情开始$Plot.begin","value":"ScriptSupportEvent:registerEvent([=[Plot.begin]=],fun)-- 任意剧情开始  eventobjid,toobjid,plotid,targetactorid","meta":"eventobjid,toobjid,plotid,targetactorid","type":"local","score":6},
{"name":"Event$Plot.end","caption":"任意剧情结束$Plot.end","value":"ScriptSupportEvent:registerEvent([=[Plot.end]=],fun)-- 任意剧情结束  eventobjid,toobjid,plotid,targetactorid","meta":"eventobjid,toobjid,plotid,targetactorid","type":"local","score":6},
{"name":"Event$QQMusic.PlayBegin","caption":"QQ音乐开始播放$QQMusic.PlayBegin","value":"ScriptSupportEvent:registerEvent([=[QQMusic.PlayBegin]=],fun)-- QQ音乐开始播放  eventobjid,qqMusicId","meta":"eventobjid,qqMusicId","type":"local","score":6},
{"name":"Event$minitimer.change","caption":"指定计时器变化$minitimer.change","value":"ScriptSupportEvent:registerEvent([=[minitimer.change]=],fun)-- 指定计时器变化  timerid,timername,timertime","meta":"timerid,timername,timertime","type":"local","score":6},
	]
	return jsonObj
}
$s('#loadPage>h3[data-v1]').remove();